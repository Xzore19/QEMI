...
with main_circ.if_test((creg_0[1],0)):
	main_circ.append(subcirc1,[1,qreg_3[0],0,qreg_0[2]])
main_circ.measure(qreg_0[0], creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_4:
	main_circ.measure(1, creg_0[1])
	with main_circ.if_test((creg_0[1],0)) as else_3:
		main_circ.append(subcirc1,[1,qreg_0[0],qreg_0[1],qreg_3[0]])
	with else_3:
			...
			with case_2(0):
				...
				with main_circ.switch(creg_0[0]) as case_1:
					...
					with case_1(1):
						...
						main_circ.append(subcirc2,[qreg_0[1],0,qreg_0[0],qreg_3[0]])
			with case_2(1):
				main_circ.append(subcirc0,[qreg_0[0],qreg_0[2],1,qreg_3[0],qreg_0[1],0])
with else_4:
	main_circ.measure(qreg_0[0], creg_0[0])
		...
		with main_circ.switch(creg_0[1]) as case_2:
			with case_2(0):
				...
				with main_circ.if_test((creg_0[1],0)) as else_1:
					...
					main_circ.x(1)
				with else_1:
					main_circ.append(subcirc1,[1,qreg_0[1],0,qreg_3[0]])
			with case_2(1):
...
run_on_simulator(main_circ, "914")

	...
	with main_circ.switch(creg_0[0]) as case_2:
		with case_2(0):
			...
			with main_circ.if_test((creg_1[0],0)):
				...
				main_circ.rz(-0.097000, qreg_0[0])
				main_circ.s(qreg_2[0])
				main_circ.rz(-0.872000, qreg_0[1])
		with case_2(1):
			...
			with else_1:
				...
				main_circ.rz(0.300000, qreg_2[0])
	...
	with case_3(0):
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			with main_circ.if_test((creg_0[0],0)) as else_1:
				main_circ.rz(-0.875000, qreg_0[1])
				main_circ.cy(qreg_0[1],qreg_0[0])
			with else_1:
				main_circ.s(qreg_0[1])
				main_circ.rz(-0.328000, qreg_0[0])
	with case_3(1):
...
with main_circ.switch(creg_1[0]) as case_3:
	with case_3(0):
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			main_circ.measure(qreg_2[0], creg_0[0])
			with main_circ.if_test((creg_0[0],0)) as else_1:
				main_circ.rz(0.339000, qreg_0[1])
	...
	with case_3(1):
		...
		with main_circ.if_test((creg_1[0],0)):
			...
			with main_circ.if_test((creg_1[0],0)):
				...
				main_circ.rz(0.395000, qreg_0[1])
main_circ.measure(qreg_0[0], creg_1[0])
with main_circ.if_test((creg_1[0],0)):
	main_circ.measure(qreg_2[0], creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
		...
		with main_circ.switch(creg_1[0]) as case_1:
			with case_1(0):
				main_circ.rz(-0.565000, qreg_2[0])
				main_circ.x(0)
				main_circ.cy(qreg_0[0],qreg_3[0])
				main_circ.x(0)
			with case_1(1):
				...
				main_circ.cy(qreg_0[1],0)
				main_circ.id(0)
bindings = {param_0: -0.368000, param_3: -0.535000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "170")

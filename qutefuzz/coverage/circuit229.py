...
subcirc0.s(qreg_0[0])
subcirc0.s(qreg_0[1])
subcirc0.rx(0.174000, qreg_3[0])
subcirc0.cz(qreg_0[0],qreg_2[0])
subcirc0.rx(-0.486000, qreg_3[0])
...
subcirc1.s(qreg_1[0])
subcirc1.s(qreg_1[1])
subcirc1.u(pi/2,0.118000,-0.398000, qreg_1[1])
subcirc1.u(pi/2,0.848000,0.463000, qreg_1[2])
subcirc1.s(qreg_0[0])
...
# Adding creg resources 
subcirc2.rx(0.727000, qreg_0[0])
subcirc2.cz(qreg_0[1],qreg_0[0])
subcirc2.u(pi/2,-0.047000,0.901000, qreg_0[0])
subcirc2.s(qreg_0[0])
subcirc2.rx(0.891000, qreg_0[2])
...
subcirc3.u(pi/2,0.844000,0.576000, qreg_1[1])
subcirc3.rx(0.933000, qreg_1[1])
subcirc3.s(qreg_1[1])
subcirc3.u(pi/2,0.200000,0.277000, qreg_1[0])
...
subcirc4.rx(-0.647000, qreg_0[0])
subcirc4.rx(-0.398000, qreg_0[0])
subcirc4.rx(-0.769000, qreg_0[0])
subcirc4.s(qreg_0[0])
	...
	with case_4(1):
		...
		with main_circ.if_test((creg_1[0],0)) as else_3:
			...
			with main_circ.if_test((creg_1[0],0)) as else_2:
				...
				with main_circ.if_test((creg_1[0],0)) as else_1:
					main_circ.rx(0.499000, qreg_1[2])
					main_circ.u(param_0,param_1,-0.487000, qreg_0[0])
				with else_1:
		...
		with else_3:
			...
			with main_circ.switch(creg_1[0]) as case_2:
				with case_2(0):
					...
					with main_circ.switch(creg_1[0]) as case_1:
						with case_1(0):
							main_circ.rx(-0.497000, qreg_0[0])
					...
					main_circ.measure(qreg_1[0], creg_1[0])
					with main_circ.if_test((creg_1[0],0)):
						main_circ.append(subcirc2,[qreg_1[2],qreg_1[0],qreg_1[1],qreg_0[0]])
				with case_2(1):
			...
			with main_circ.switch(creg_1[0]) as case_2:
				...
				with case_2(1):
					...
					with main_circ.if_test((creg_0[0],0)) as else_1:
						...
						main_circ.barrier(qreg_1[0])
					with else_1:
						main_circ.u(pi/2,-0.362000,param_2, qreg_1[0])
						main_circ.barrier(qreg_1[0])
with else_4:
	main_circ.id(qreg_1[1])
main_circ.measure(qreg_1[1], creg_1[0])
with main_circ.if_test((creg_1[0],0)):
	...
	with main_circ.if_test((creg_1[0],0)):
		...
		with main_circ.if_test((creg_1[0],0)):
			...
			with main_circ.if_test((creg_0[0],0)) as else_1:
				main_circ.u(pi/2,0.645000,param_0, qreg_1[1])
				main_circ.id(qreg_1[0])
			with else_1:
				main_circ.cz(qreg_1[0],qreg_1[1])
main_circ.measure(qreg_1[0], creg_0[0])
...
with else_4:
	main_circ.id(qreg_0[0])
bindings = {param_0: -0.283000, param_1: 0.923000, param_2: 0.641000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "229")

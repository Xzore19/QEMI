...
subcirc1.y(qreg_0[3])
subcirc1.rz(0.754000, qreg_0[2])
subcirc1.y(qreg_0[1])
subcirc1.rz(0.110000, qreg_0[1])
subcirc1.y(qreg_0[2])
...
# Adding creg resources 
subcirc2.rz(-0.291000, qreg_0[0])
subcirc2.cx(qreg_0[1],qreg_0[0])
subcirc2.y(qreg_0[1])
subcirc2.rz(0.682000, qreg_0[0])
subcirc2.cz(qreg_0[2],qreg_0[0])
subcirc2.rz(0.511000, qreg_0[0])
...
subcirc4.rz(0.735000, qreg_0[1])
subcirc4.rz(-0.501000, qreg_0[0])
subcirc4.cx(qreg_0[0],qreg_0[1])
...
with else_2:
	...
	with main_circ.if_test((creg_1[0],0)) as else_1:
		main_circ.rz(-0.640000, qreg_3[0])
...
with main_circ.switch(creg_0[0]) as case_2:
	with case_2(0):
		...
		with else_1:
			...
			main_circ.rz(-0.358000, qreg_0[0])
			main_circ.barrier(qreg_0[1])
		main_circ.measure(qreg_0[1], creg_1[0])
		with main_circ.if_test((creg_1[0],0)):
	...
	with case_2(1):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			...
			with case_1(1):
				main_circ.id(qreg_3[0])
		main_circ.id(qreg_0[2])
bindings = {param_0: -0.093000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1819", "ConsolidateBlocks")

...
subcirc0.u(-0.433000,-0.766000,0.989000, qreg_2[0])
subcirc0.rz(0.963000, qreg_3[0])
subcirc0.rz(-0.856000, qreg_3[0])
	...
	with main_circ.if_test((creg_0[0],0)) as else_3:
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			...
			with else_1:
				...
				main_circ.u(param_1,0.071000,0.266000, qreg_0[3])
				main_circ.barrier(qreg_0[2])
			main_circ.measure(qreg_0[2], creg_0[1])
			with main_circ.switch(creg_0[1]) as case_1:
				with case_1(0):
					main_circ.u(0.858000,param_0,param_1, qreg_0[2])
		...
		with else_2:
			main_circ.rz(0.735000, qreg_0[2])
	...
	with else_3:
		...
		with main_circ.switch(creg_0[0]) as case_2:
			...
			with case_2(1):
				...
				with main_circ.if_test((creg_0[1],0)) as else_1:
					main_circ.rz(0.920000, qreg_0[0])
					main_circ.cy(qreg_0[1],qreg_0[3])
					main_circ.cy(qreg_0[0],qreg_0[1])
				with else_1:
					main_circ.u(param_0,-0.331000,param_0, qreg_0[0])
					main_circ.cy(qreg_0[1],qreg_0[0])
					main_circ.u(-0.711000,0.459000,-0.685000, qreg_0[1])
					main_circ.cy(qreg_0[1],qreg_0[3])
main_circ.measure(qreg_0[1], creg_0[0])
with main_circ.if_test((creg_0[0],0)):
	...
	with main_circ.if_test((creg_0[0],0)):
		main_circ.cx(qreg_0[3],qreg_0[2])
		main_circ.rz(0.273000, qreg_0[0])
	...
	with main_circ.if_test((creg_0[0],0)):
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			...
			with main_circ.if_test((creg_0[1],0)):
				...
				main_circ.u(param_1,0.357000,param_0, qreg_0[1])
...
with else_4:
	...
	with main_circ.if_test((creg_0[1],0)):
		...
		with main_circ.if_test((creg_0[1],0)) as else_2:
			main_circ.u(-0.363000,0.823000,-0.536000, qreg_0[1])
			main_circ.measure(qreg_0[2], creg_0[0])
			with main_circ.switch(creg_0[0]) as case_1:
				with case_1(0):
				...
				with case_1(1):
					...
					main_circ.rz(-0.187000, qreg_0[1])
					main_circ.rz(param_1, qreg_0[1])
		with else_2:
			main_circ.measure(qreg_0[0], creg_0[0])
			with main_circ.if_test((creg_0[0],0)):
				main_circ.cy(qreg_0[2],qreg_0[1])
				main_circ.rz(-0.344000, qreg_0[2])
main_circ.measure(qreg_0[0], creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_4:
	main_circ.measure(qreg_0[2], creg_0[0])
	with main_circ.if_test((creg_0[0],0)) as else_3:
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			...
			with main_circ.switch(creg_0[0]) as case_1:
				with case_1(0):
					main_circ.u(0.789000,-0.657000,-0.207000, qreg_0[2])
...
with else_4:
	...
	with else_3:
		main_circ.id(qreg_0[1])
	main_circ.barrier(qreg_0[0])
bindings = {param_0: -0.911000, param_1: -0.323000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "765", "NormalizeRXAngle")

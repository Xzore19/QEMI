...
subcirc0.rx(0.311000, qreg_0[2])
subcirc0.cy(qreg_0[1],qreg_0[3])
subcirc0.rx(-0.124000, qreg_0[1])
...
subcirc1.rx(-0.212000, qreg_0[2])
subcirc1.rx(-0.044000, qreg_0[1])
...
# Adding creg resources 
subcirc2.z(qreg_0[1])
subcirc2.rx(0.998000, qreg_0[0])
subcirc2.cy(qreg_0[1],qreg_0[0])
subcirc2.cx(qreg_0[0],qreg_2[0])
subcirc2.rx(0.433000, qreg_0[1])
...
with main_circ.if_test((creg_0[1],0)) as else_4:
	...
	with main_circ.if_test((creg_0[0],0)):
		...
		with else_2:
			main_circ.id(0)
with else_4:
	main_circ.append(subcirc0,[1,3,2,qreg_0[0],0])
		...
		with case_3(1):
			...
			with main_circ.switch(creg_0[0]) as case_2:
				...
				with case_2(1):
					...
					with else_1:
						main_circ.cy(0,3)
						main_circ.append(subcirc0,[3,1,2,0,qreg_0[0]])
with else_4:
		...
		with case_3(0):
			...
			with main_circ.switch(creg_0[0]) as case_2:
				with case_2(0):
					...
					with main_circ.switch(creg_0[1]) as case_1:
						with case_1(0):
							main_circ.rx(-0.835000, 3)
							main_circ.rx(0.020000, qreg_0[0])
							main_circ.barrier(2)
						with case_1(1):
							main_circ.cy(0,1)
		...
		with case_3(1):
			...
			with main_circ.if_test((creg_0[1],0)):
				...
				with main_circ.switch(creg_0[0]) as case_1:
					with case_1(0):
						main_circ.cy(1,0)
						main_circ.rx(-0.670000, 2)
						main_circ.rx(0.701000, 1)
						main_circ.rx(param_0, qreg_0[0])
					with case_1(1):
						main_circ.rx(-0.533000, 1)
						main_circ.id(2)
main_circ.measure(qreg_0[0], creg_0[0])
		...
		with else_3:
			...
			with else_2:
				...
				with main_circ.if_test((creg_0[1],0)):
					main_circ.id(2)
				main_circ.id(qreg_0[0])
bindings = {param_0: 0.708000, param_1: -0.797000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1078", "TemplateOptimization")

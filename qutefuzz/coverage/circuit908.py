...
# Adding creg resources 
subcirc1.z(qreg_0[3])
subcirc1.u(-0.470000,0.478000,0.984000, qreg_0[0])
...
# Adding creg resources 
subcirc2.z(qreg_3[0])
subcirc2.u(-0.711000,-0.242000,0.188000, qreg_3[0])
subcirc2.z(qreg_0[0])
subcirc2.cz(qreg_0[0],qreg_2[0])
subcirc2.u(0.861000,0.164000,-0.894000, qreg_3[0])
subcirc2.z(qreg_3[0])
...
subcirc3.u(0.862000,0.103000,-0.197000, qreg_3[0])
subcirc3.u(-0.976000,-0.050000,-0.864000, qreg_2[0])
...
subcirc4.z(qreg_0[0])
subcirc4.z(qreg_3[0])
subcirc4.u(-0.206000,-0.161000,-0.112000, qreg_0[0])
subcirc4.z(qreg_0[1])
...
main_circ.u(0.770000,0.761000,-0.299000, qreg_3[0])
...
with main_circ.if_test((creg_1[0],0)) as else_4:
	main_circ.append(subcirc1,[qreg_0[0],1,qreg_3[0],0])
with else_4:
		...
		with case_3(0):
			...
			with main_circ.if_test((creg_1[0],0)) as else_2:
				...
				with main_circ.if_test((creg_0[0],0)) as else_1:
					main_circ.append(subcirc4,[qreg_0[1],1,0,qreg_3[0]])
				with else_1:
					main_circ.u(-0.544000,param_1,param_1, 0)
			with else_2:
				...
				with main_circ.if_test((creg_1[0],0)) as else_1:
					...
					main_circ.append(subcirc4,[0,1,qreg_3[0],qreg_0[0]])
				with else_1:
		...
		with case_3(1):
			...
			with main_circ.if_test((creg_0[0],0)):
				...
				with main_circ.if_test((creg_0[0],0)) as else_1:
					...
					main_circ.append(subcirc2,[1,qreg_0[1],qreg_3[0],qreg_2[0],0,qreg_0[0]])
				with else_1:
					main_circ.append(subcirc2,[1,qreg_0[1],0,qreg_3[0],qreg_0[0],qreg_2[0]])
main_circ.measure(qreg_3[0], creg_1[0])
with main_circ.if_test((creg_1[0],0)) as else_4:
	main_circ.measure(0, creg_0[0])
	with main_circ.if_test((creg_0[0],0)) as else_3:
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			with main_circ.switch(creg_0[0]) as case_1:
				with case_1(0):
					main_circ.u(param_1,param_0,-0.921000, qreg_3[0])
...
with else_4:
	...
	with else_3:
		main_circ.id(qreg_3[0])
	main_circ.barrier(1)
bindings = {param_0: 0.367000, param_1: -0.041000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "908")

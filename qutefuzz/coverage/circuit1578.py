...
# Adding creg resources 
subcirc1.ry(-0.481000, qreg_0[0])
subcirc1.ry(-0.342000, qreg_3[0])
subcirc1.x(qreg_0[0])
subcirc1.x(qreg_0[0])
subcirc1.ry(-0.631000, qreg_0[0])
subcirc1.z(qreg_3[0])
...
main_circ.append(subcirc3,[qreg_0[0],qreg_1[0],0,3,1,2])
main_circ.append(subcirc2,[1,qreg_1[0],0,3,qreg_0[0],2])
main_circ.ry(0.428000, qreg_1[0])
main_circ.append(subcirc2,[qreg_1[0],1,2,3,qreg_0[0],0])

...
subcirc2.rz(0.715000, qreg_2[0])
subcirc2.cz(qreg_2[1],qreg_0[0])
subcirc2.rz(0.235000, qreg_0[1])
...
subcirc3.rz(0.000000, qreg_1[2])
subcirc3.rz(0.111000, qreg_0[0])
subcirc3.rz(0.126000, qreg_1[2])
...
main_circ.append(subcirc0,[qreg_0[0],1,3,2,0])

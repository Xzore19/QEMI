...
subcirc0.h(qreg_0[1])
subcirc0.h(qreg_0[1])
subcirc0.ry(-0.145000, qreg_0[2])
subcirc0.x(qreg_0[1])
subcirc0.ry(-0.693000, qreg_3[0])
...
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.ry(0.245000, qreg_0[2])
...
with else_1:
	main_circ.x(qreg_0[1])
main_circ.ry(-0.278000, qreg_0[3])
main_circ.measure(qreg_0[2], creg_1[0])
with main_circ.if_test((creg_1[0],0)):
	main_circ.x(qreg_0[3])
main_circ.measure(qreg_0[0], creg_1[0])
with main_circ.if_test((creg_1[0],0)):
	main_circ.barrier(qreg_0[0])
main_circ.ry(-0.624000, qreg_0[3])
main_circ.measure(qreg_0[3], creg_0[0])
with main_circ.if_test((creg_0[0],0)):
...
with main_circ.switch(creg_1[0]) as case_1:
	...
	with case_1(1):
		main_circ.x(qreg_0[3])
		main_circ.id(qreg_0[1])
bindings = {param_0: -0.757000, param_1: 0.868000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1446")

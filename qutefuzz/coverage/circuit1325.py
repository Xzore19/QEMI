...
main_circ.append(subcirc1,[1,0,qreg_0[0],qreg_3[0]])
main_circ.append(subcirc0,[qreg_3[0],qreg_0[1],qreg_0[0],qreg_0[2]])
main_circ.z(1)
main_circ.append(subcirc0,[qreg_0[2],1,qreg_3[0],0])
...
main_circ.append(subcirc1,[qreg_3[0],0,1,qreg_0[1]])
main_circ.append(subcirc1,[qreg_0[0],qreg_3[0],1,0])
main_circ.append(subcirc0,[qreg_3[0],0,qreg_0[1],qreg_0[0]])
...
run_routing_simulation(main_circ, "1325")

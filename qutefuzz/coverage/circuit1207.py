...
# Adding creg resources 
subcirc2.rz(0.849000, qreg_0[0])
subcirc2.cz(qreg_3[0],qreg_0[0])
subcirc2.y(qreg_3[0])
subcirc2.cy(qreg_3[0],qreg_0[0])
subcirc2.rz(-0.098000, qreg_0[1])
...
main_circ.append(subcirc1,[qreg_0[0],qreg_1[0],3,1])
main_circ.append(subcirc3,[3,qreg_1[0],qreg_0[0],1])
main_circ.y(1)
main_circ.cz(2,0)
main_circ.append(subcirc0,[qreg_0[0],1,3,qreg_1[0]])
main_circ.y(3)
main_circ.rz(param_1, 2)
main_circ.append(subcirc1,[2,3,1,qreg_0[0]])
main_circ.append(subcirc3,[3,qreg_1[0],qreg_0[0],0])
main_circ.append(subcirc3,[qreg_0[0],0,3,qreg_1[0]])
main_circ.cy(qreg_1[0],2)
main_circ.rz(param_1, 0)
main_circ.cy(1,qreg_0[0])
bindings = {param_1: -0.309000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "1207")

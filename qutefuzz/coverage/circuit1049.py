...
main_circ.append(subcirc2,[0,qreg_1[0],3,qreg_0[0],2])
...
with else_3:
	...
	with else_2:
		...
		with else_1:
			main_circ.x(3)
			main_circ.append(subcirc2,[0,3,qreg_1[0],2,1])
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			...
			with main_circ.switch(creg_0[1]) as case_1:
				...
				with case_1(1):
					...
					main_circ.append(subcirc1,[qreg_1[0],qreg_0[0],1,3])
		with else_2:
			main_circ.measure(2, creg_0[0])
			with main_circ.switch(creg_0[0]) as case_1:
				with case_1(0):
					main_circ.append(subcirc1,[qreg_1[0],3,0,1])
				with case_1(1):
					main_circ.append(subcirc4,[qreg_1[0],1,2,qreg_0[0],3,0])
	with case_3(1):
		main_circ.measure(1, creg_0[1])
		with main_circ.if_test((creg_0[1],0)) as else_2:
...
run_on_simulator(main_circ, "1049")

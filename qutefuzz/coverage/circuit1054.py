...
with else_4:
	...
	with main_circ.if_test((creg_1[0],0)) as else_3:
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			...
			with main_circ.if_test((creg_1[0],0)):
				main_circ.append(subcirc3,[qreg_0[2],qreg_0[0],qreg_0[1],0])
		with else_2:
	...
	with else_3:
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			main_circ.measure(0, creg_1[0])
			with main_circ.if_test((creg_1[0],0)):
				main_circ.append(subcirc2,[qreg_0[1],qreg_0[2],qreg_0[0],qreg_3[0],0])
		with else_2:
			...
			with case_3(0):
				...
				with else_2:
					...
					with main_circ.if_test((creg_1[0],0)) as else_1:
						main_circ.y(0)
					with else_1:
						main_circ.append(subcirc2,[qreg_0[2],qreg_3[0],0,qreg_0[1],qreg_0[0]])
			with case_3(1):
				main_circ.measure(0, creg_1[0])
				...
				with else_2:
					...
					with else_1:
						main_circ.cy(qreg_0[2],qreg_0[0])
						main_circ.cy(0,qreg_0[2])
						main_circ.append(subcirc0,[qreg_0[1],qreg_0[0],0,qreg_3[0]])
	with case_4(1):
...
run_pass_on_simulator(main_circ, "1054", "ConsolidateBlocks")

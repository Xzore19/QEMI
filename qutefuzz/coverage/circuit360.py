...
subcirc0.u(0,0,-0.938000, qreg_3[0])
subcirc0.z(qreg_0[1])
subcirc0.u(0,0,0.705000, qreg_0[1])
subcirc0.cy(qreg_0[1],qreg_0[0])
subcirc0.z(qreg_0[2])
subcirc0.u(0,0,-0.413000, qreg_0[1])
...
subcirc1.u(0,0,0.629000, qreg_1[0])
...
# Adding creg resources 
subcirc2.u(0,0,0.690000, qreg_2[1])
subcirc2.u(pi/2,-0.233000,0.652000, qreg_2[0])
subcirc2.z(qreg_2[0])
...
with else_2:
	...
	with main_circ.switch(creg_0[0]) as case_1:
		...
		with case_1(1):
			...
			main_circ.u(pi/2,0.326000,0.336000, 0)
			main_circ.u(pi/2,param_4,-0.547000, 3)
...
with main_circ.if_test((creg_0[0],0)):
	...
	main_circ.measure(0, creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
		main_circ.u(0,param_4,0.200000, 3)
		main_circ.id(2)
	main_circ.measure(2, creg_0[0])
	with main_circ.if_test((creg_0[0],0)) as else_1:
		main_circ.z(0)
...
with main_circ.if_test((creg_0[0],0)) as else_2:
	main_circ.u(param_5,0,-0.458000, 0)
...
with else_2:
	...
	with main_circ.switch(creg_1[0]) as case_1:
		...
		with case_1(1):
			main_circ.barrier(qreg_0[0])
	main_circ.barrier(2)
bindings = {param_4: 0.162000, param_5: 0.376000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "360")

...
subcirc0.rx(-0.605000, qreg_0[1])
subcirc0.x(qreg_2[0])
subcirc0.x(qreg_0[0])
subcirc0.rx(0.709000, qreg_0[0])
...
main_circ.cx(2,0)
main_circ.z(1)
bindings = {param_1: 0.623000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "1069")

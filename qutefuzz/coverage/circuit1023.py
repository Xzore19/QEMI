...
# Adding creg resources 
subcirc1.rz(-0.942000, qreg_1[1])
subcirc1.h(qreg_1[2])
subcirc1.h(qreg_1[2])
subcirc1.rz(-0.987000, qreg_1[1])
subcirc1.rz(-0.744000, qreg_1[1])
subcirc1.h(qreg_1[1])
...
subcirc2.rz(0.740000, qreg_0[1])
subcirc2.h(qreg_0[3])
subcirc2.h(qreg_0[0])
subcirc2.rz(-0.235000, qreg_0[2])
...
main_circ.cz(3,2)
main_circ.cy(0,3)
main_circ.rz(-0.971000, 0)
main_circ.append(subcirc1,[1,3,0,2])
bindings = {param_2: 0.252000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "1023")

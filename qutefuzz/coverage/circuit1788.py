...
subcirc0.u(pi/2,0.091000,0.931000, qreg_2[0])
...
subcirc1.u(pi/2,0.292000,-0.034000, qreg_0[0])
...
subcirc2.u(pi/2,0.243000,0.807000, qreg_0[0])
subcirc2.u(pi/2,0.617000,-0.937000, qreg_0[0])
...
# Adding creg resources 
subcirc3.u(pi/2,-0.292000,-0.984000, qreg_2[0])
subcirc3.z(qreg_2[0])
subcirc3.u(pi/2,0.532000,-0.664000, qreg_2[1])
subcirc3.z(qreg_0[0])
subcirc3.u(pi/2,0.742000,0.709000, qreg_0[0])
subcirc3.z(qreg_0[1])
...
main_circ.u(param_0,0.664000,param_0, 2)
main_circ.cy(1,0)
	...
	with case_4(1):
		...
		with else_3:
			...
			with main_circ.if_test((creg_1[0],0)):
				...
				with else_1:
					main_circ.barrier(2)
				main_circ.u(param_0,param_1,-0.819000, 2)
			main_circ.measure(3, creg_1[0])
		...
		with case_3(1):
			...
			with main_circ.switch(creg_1[0]) as case_2:
				...
				with case_2(1):
					...
					main_circ.barrier(0)
			main_circ.id(2)
bindings = {param_0: -0.695000, param_1: 0.348000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1788", "CommutationAnalysis")

		...
		with case_3(0):
			...
			with main_circ.if_test((creg_0[1],0)):
				...
				with main_circ.if_test((creg_0[1],0)) as else_1:
					main_circ.z(1)
					main_circ.append(subcirc0,[3,2,qreg_1[0],0])
				with else_1:
					main_circ.append(subcirc0,[3,1,qreg_0[0],qreg_1[0]])
		with case_3(1):
			main_circ.measure(2, creg_0[1])
			with main_circ.if_test((creg_0[1],0)) as else_2:
				main_circ.append(subcirc0,[qreg_0[0],3,1,qreg_1[0]])
				main_circ.measure(0, creg_0[0])
				with main_circ.if_test((creg_0[0],0)) as else_1:
					main_circ.rx(0.785000, 0)
				with else_1:
					main_circ.cy(3,0)
					main_circ.append(subcirc1,[1,qreg_1[0],0,2,3])
			with else_2:
				main_circ.h(2)
...
run_on_simulator(main_circ, "1503")

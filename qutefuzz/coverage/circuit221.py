...
with main_circ.switch(creg_1[0]) as case_1:
	...
	with case_1(1):
		main_circ.y(1)
		main_circ.append(subcirc0,[qreg_0[1],1,qreg_0[0],2])
main_circ.measure(qreg_0[0], creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.y(3)
with else_1:
	main_circ.append(subcirc1,[1,0,2,3,qreg_0[0]])
	main_circ.append(subcirc0,[3,2,qreg_0[0],qreg_0[1]])
main_circ.measure(0, creg_1[0])
with main_circ.switch(creg_1[0]) as case_1:
	with case_1(0):
...
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.append(subcirc1,[1,2,qreg_0[1],3,0])
	main_circ.cz(1,3)
with else_1:
	main_circ.cz(3,2)
	main_circ.y(0)
...
run_pass_on_simulator(main_circ, "221", "OptimizeAnnotated")

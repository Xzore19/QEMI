...
subcirc0.s(qreg_1[2])
subcirc0.y(qreg_0[0])
subcirc0.u(0,0,0.503000, qreg_1[2])
subcirc0.s(qreg_1[0])
...
main_circ.rz(0.987000, qreg_0[3])
...
main_circ.rz(-0.223000, qreg_0[3])
main_circ.rz(-0.714000, qreg_0[3])
...
main_circ.u(param_1,param_1,0.125000, qreg_0[1])
main_circ.y(qreg_0[3])
main_circ.rz(0.862000, qreg_0[3])
bindings = {param_1: -0.739000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "852")

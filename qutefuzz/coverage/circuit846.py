...
subcirc0.u(-0.884000,0.227000,0.500000, qreg_0[0])
subcirc0.u(pi/2,0.606000,0.748000, qreg_1[0])
subcirc0.u(0.597000,0.963000,0.888000, qreg_0[0])
subcirc0.cy(qreg_1[0],qreg_2[1])
subcirc0.h(qreg_0[0])
...
with main_circ.if_test((creg_0[0],0)) as else_4:
	main_circ.u(pi/2,param_1,-0.713000, qreg_0[3])
	...
	with main_circ.if_test((creg_0[1],0)):
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			with else_1:
				...
				main_circ.u(-0.555000,param_0,param_0, qreg_0[1])
with else_4:
	main_circ.u(pi/2,param_0,0.334000, qreg_0[2])
	...
	with main_circ.if_test((creg_0[0],0)) as else_3:
		...
		with main_circ.switch(creg_0[1]) as case_2:
			with case_2(0):
				...
				with main_circ.if_test((creg_0[1],0)) as else_1:
					main_circ.u(param_0,0.103000,param_0, qreg_0[0])
					main_circ.append(subcirc0,[qreg_0[3],qreg_0[1],qreg_0[2],qreg_0[0]])
				with else_1:
					main_circ.u(0.726000,param_0,-0.567000, qreg_0[2])
			with case_2(1):
				main_circ.measure(qreg_0[2], creg_0[1])
		...
		with main_circ.switch(creg_0[0]) as case_2:
			...
			with case_2(1):
				...
				with main_circ.if_test((creg_0[0],0)) as else_1:
					main_circ.cy(qreg_0[2],qreg_0[3])
				with else_1:
					main_circ.u(param_0,-0.296000,param_0, qreg_0[3])
				main_circ.measure(qreg_0[2], creg_0[0])
				with main_circ.if_test((creg_0[0],0)):
...
with main_circ.if_test((creg_0[1],0)):
	...
	with main_circ.switch(creg_0[0]) as case_3:
		...
		with case_3(1):
			...
			main_circ.id(qreg_0[1])
	main_circ.barrier(qreg_0[1])
bindings = {param_0: 0.316000, param_1: -0.071000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "846")

...
# Adding creg resources 
subcirc1.rx(0.732000, qreg_3[0])
subcirc1.cx(qreg_0[1],qreg_3[0])
subcirc1.rx(0.824000, qreg_0[2])
subcirc1.x(qreg_0[2])
...
subcirc2.y(qreg_0[0])
subcirc2.cx(qreg_2[0],qreg_1[0])
subcirc2.y(qreg_2[1])
subcirc2.rx(0.735000, qreg_0[0])
...
# Adding creg resources 
subcirc3.rx(0.610000, qreg_0[1])
subcirc3.cx(qreg_0[3],qreg_0[1])
subcirc3.cx(qreg_0[3],qreg_0[0])
subcirc3.rx(-0.882000, qreg_0[0])
subcirc3.x(qreg_0[1])
subcirc3.y(qreg_0[0])
...
main_circ.append(subcirc3,[qreg_2[0],qreg_0[0],qreg_2[1],qreg_1[0]])
main_circ.y(qreg_0[0])
main_circ.x(qreg_1[0])
main_circ.append(subcirc0,[qreg_2[1],qreg_0[0],qreg_2[0],qreg_1[0]])
...
main_circ.append(subcirc3,[qreg_0[0],qreg_2[1],qreg_2[0],qreg_1[0]])
main_circ.cx(qreg_2[1],qreg_0[0])
bindings = {param_4: -0.609000, }

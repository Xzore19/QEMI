...
subcirc1.ry(-0.146000, qreg_0[0])
subcirc1.ry(0.462000, qreg_0[0])
...
# Adding creg resources 
subcirc4.ry(0.645000, qreg_2[0])
subcirc4.ry(-0.539000, qreg_2[0])
subcirc4.cx(qreg_0[0],qreg_2[1])
subcirc4.ry(0.890000, qreg_0[1])
subcirc4.cy(qreg_2[0],qreg_2[1])
subcirc4.ry(-0.542000, qreg_2[1])
...
with else_2:
	...
	with main_circ.switch(creg_0[1]) as case_1:
		...
		with case_1(1):
			main_circ.h(3)
			main_circ.cy(3,2)
			main_circ.ry(-0.795000, 1)
			main_circ.ry(0.662000, 3)
	main_circ.barrier(1)
bindings = {}
...
run_on_simulator(main_circ, "1026")

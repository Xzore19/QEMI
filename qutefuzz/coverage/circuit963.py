	...
	with main_circ.if_test((creg_0[0],0)) as else_3:
		...
		with main_circ.if_test((creg_1[0],0)) as else_2:
			...
			with main_circ.if_test((creg_1[0],0)) as else_1:
				main_circ.x(2)
				main_circ.append(subcirc2,[2,qreg_1[0],qreg_0[0],1])
			with else_1:
				main_circ.cx(3,0)
		with else_2:
	...
	with else_3:
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			with else_1:
				main_circ.y(2)
with else_4:
	main_circ.append(subcirc2,[qreg_0[0],3,0,2])
main_circ.measure(3, creg_0[0])
with main_circ.if_test((creg_0[0],0)):
	main_circ.measure(1, creg_1[0])
	with main_circ.if_test((creg_1[0],0)):
		main_circ.append(subcirc0,[1,3,2,qreg_1[0],0,qreg_0[0]])
main_circ.measure(2, creg_1[0])
with main_circ.if_test((creg_1[0],0)):
	main_circ.measure(1, creg_0[0])
	with main_circ.switch(creg_0[0]) as case_3:
		with case_3(0):
			main_circ.append(subcirc1,[qreg_1[0],3,1,qreg_0[0],0])
		with case_3(1):
				...
				with case_2(0):
					...
					with main_circ.switch(creg_0[0]) as case_1:
						...
						with case_1(1):
							main_circ.cx(3,2)
							main_circ.x(3)
							main_circ.append(subcirc0,[3,0,qreg_0[0],2,qreg_1[0],1])
				with case_2(1):
...
run_on_simulator(main_circ, "963")

...
with else_2:
	...
	with main_circ.switch(creg_1[0]) as case_1:
		with case_1(0):
			main_circ.append(subcirc1,[qreg_0[1],qreg_0[0],qreg_2[0],0])
		with case_1(1):
...
with main_circ.if_test((creg_0[0],0)):
	...
	with main_circ.if_test((creg_1[0],0)) as else_1:
		...
		main_circ.append(subcirc1,[0,qreg_0[1],qreg_3[0],qreg_2[0]])
	with else_1:
		main_circ.id(0)
...
with main_circ.if_test((creg_0[0],0)) as else_2:
	...
	with main_circ.if_test((creg_1[0],0)):
		...
		main_circ.ry(-0.788000, qreg_0[0])
...
bindings = {param_0: -0.500000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "386", "Optimize1qGatesDecomposition")

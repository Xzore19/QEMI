...
subcirc0.rx(-0.626000, qreg_0[1])
subcirc0.rx(-0.363000, qreg_0[1])
subcirc0.s(qreg_2[0])
subcirc0.rx(-0.519000, qreg_2[0])
subcirc0.cx(qreg_2[1],qreg_2[0])
subcirc0.rx(0.262000, qreg_2[1])
...
subcirc2.h(qreg_0[0])
subcirc2.s(qreg_0[0])
subcirc2.rx(0.060000, qreg_0[3])
subcirc2.rx(0.510000, qreg_0[3])
subcirc2.h(qreg_0[2])
subcirc2.rx(-0.538000, qreg_0[2])
...
# Adding creg resources 
subcirc3.rx(-0.995000, qreg_1[1])
subcirc3.h(qreg_1[1])
subcirc3.rx(-0.173000, qreg_0[0])
...
with else_1:
	main_circ.barrier(0)
bindings = {param_0: 0.971000, param_1: 0.859000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1139")

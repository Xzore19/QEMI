...
subcirc0.ry(-0.252000, qreg_3[0])
subcirc0.cy(qreg_3[0],qreg_0[1])
subcirc0.ry(-0.625000, qreg_0[0])
subcirc0.ry(-0.858000, qreg_0[0])
...
with main_circ.switch(creg_0[1]) as case_1:
	with case_1(0):
		main_circ.append(subcirc1,[qreg_0[1],0,1,qreg_0[2],qreg_0[3],qreg_0[0]])
	with case_1(1):
		main_circ.ry(param_1, qreg_0[1])
		main_circ.append(subcirc1,[qreg_0[3],1,0,qreg_0[1],qreg_0[0],qreg_0[2]])
main_circ.z(qreg_0[3])
main_circ.z(1)
main_circ.append(subcirc1,[qreg_0[1],0,qreg_0[2],qreg_0[3],1,qreg_0[0]])
...
with main_circ.switch(creg_0[0]) as case_1:
	with case_1(0):
		...
		main_circ.ry(-0.526000, qreg_0[1])
	with case_1(1):
...
with else_1:
	main_circ.append(subcirc1,[qreg_0[1],qreg_0[3],qreg_0[2],0,qreg_0[0],1])
main_circ.measure(qreg_0[1], creg_0[1])
with main_circ.if_test((creg_0[1],0)) as else_1:
	main_circ.cy(qreg_0[3],0)
	main_circ.z(qreg_0[1])
	main_circ.ry(0.382000, 0)
	main_circ.z(0)
with else_1:
...
bindings = {param_0: -0.968000, param_1: -0.541000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1768", "OptimizeAnnotated")

...
subcirc1.h(qreg_0[2])
subcirc1.u(0,0,-0.296000, qreg_0[2])
		...
		with case_2(1):
			...
			with main_circ.switch(creg_0[0]) as case_1:
				with case_1(0):
					...
					main_circ.u(param_1,0,0.505000, qreg_2[0])
					main_circ.u(param_1,0,-0.850000, qreg_0[1])
				with case_1(1):
					main_circ.h(qreg_2[0])
	...
	with main_circ.switch(creg_0[0]) as case_2:
		with case_2(0):
			...
			with else_1:
				...
				main_circ.u(param_0,0,param_1, qreg_2[0])
		with case_2(1):
			main_circ.measure(qreg_0[0], creg_0[0])
			with main_circ.if_test((creg_0[0],0)) as else_1:
...
with main_circ.switch(creg_0[1]) as case_3:
	with case_3(0):
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			with else_1:
				main_circ.x(qreg_0[0])
				main_circ.u(0,0,-0.353000, qreg_0[0])
	with case_3(1):
	...
	with case_3(1):
		...
		with main_circ.switch(creg_0[1]) as case_2:
			...
			with case_2(1):
				...
				main_circ.id(qreg_0[0])
		main_circ.id(qreg_2[0])
bindings = {param_0: -0.110000, param_1: -0.689000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1174", "RemoveResetInZeroState")

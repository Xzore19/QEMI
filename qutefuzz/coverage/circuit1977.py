...
# Adding creg resources 
subcirc1.u(0,0,-0.346000, qreg_0[3])
subcirc1.z(qreg_0[3])
subcirc1.z(qreg_0[0])
subcirc1.z(qreg_0[3])
...
main_circ.u(0,param_0,0.346000, qreg_0[0])
main_circ.append(subcirc1,[qreg_0[0],qreg_0[3],qreg_0[2],qreg_0[1],0])
...
main_circ.append(subcirc1,[qreg_0[0],0,qreg_0[2],qreg_0[3],qreg_0[1]])
main_circ.cz(qreg_0[1],qreg_0[0])
main_circ.z(qreg_0[0])
main_circ.z(qreg_0[2])
main_circ.append(subcirc0,[qreg_0[0],qreg_0[1],qreg_0[3],qreg_0[2]])
main_circ.u(param_3,0,param_3, qreg_0[1])
main_circ.z(qreg_0[2])
...
main_circ.cz(qreg_0[1],qreg_0[2])
main_circ.append(subcirc1,[qreg_0[3],0,qreg_0[2],qreg_0[0],qreg_0[1]])
main_circ.cy(qreg_0[2],qreg_0[0])
main_circ.append(subcirc1,[qreg_0[1],0,qreg_0[2],qreg_0[3],qreg_0[0]])
bindings = {param_0: 0.405000, param_1: -0.900000, param_2: 0.181000, param_3: 0.765000, }

...
with main_circ.switch(creg_0[0]) as case_3:
	with case_3(0):
		main_circ.rx(0.150000, qreg_0[1])
	...
	with case_3(1):
		...
		with main_circ.switch(creg_1[0]) as case_2:
			with case_2(0):
				main_circ.measure(0, creg_0[0])
				with main_circ.if_test((creg_0[0],0)):
					main_circ.rx(-0.892000, qreg_0[1])
					main_circ.cx(qreg_0[2],qreg_0[1])
					main_circ.x(qreg_0[1])
					main_circ.rx(0.505000, qreg_0[0])
			...
			with case_2(1):
				...
				with main_circ.switch(creg_0[0]) as case_1:
					...
					with case_1(1):
						...
						main_circ.rx(-0.917000, qreg_3[0])
main_circ.measure(qreg_0[0], creg_0[0])
with main_circ.if_test((creg_0[0],0)):
	main_circ.x(qreg_0[1])
main_circ.measure(1, creg_1[0])
with main_circ.if_test((creg_1[0],0)):
	main_circ.rx(-0.969000, qreg_0[2])
	main_circ.h(1)
...
with main_circ.switch(creg_0[0]) as case_3:
	...
	with case_3(1):
		...
		with else_2:
			...
			main_circ.id(0)
		main_circ.id(qreg_0[0])
bindings = {param_0: 0.231000, param_2: 0.149000, param_7: -0.214000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1741", "InverseCancellation")

...
main_circ.append(subcirc2,[qreg_0[2],qreg_0[3],qreg_0[1],0,qreg_0[0]])
main_circ.append(subcirc3,[1,0,qreg_0[3],qreg_0[1]])
main_circ.y(0)
main_circ.z(1)
...
main_circ.append(subcirc1,[qreg_0[2],qreg_0[1],0,qreg_0[0],1,qreg_0[3]])
main_circ.cz(qreg_0[0],0)
main_circ.cx(qreg_0[1],qreg_0[3])
main_circ.y(0)
main_circ.y(qreg_0[0])
main_circ.append(subcirc0,[1,0,qreg_0[3],qreg_0[2],qreg_0[0]])
main_circ.cz(qreg_0[1],qreg_0[2])
main_circ.append(subcirc3,[qreg_0[0],qreg_0[1],0,1])
main_circ.append(subcirc1,[1,qreg_0[2],qreg_0[1],0,qreg_0[3],qreg_0[0]])
...
run_routing_simulation(main_circ, "266")

...
# Adding creg resources 
subcirc3.rz(-0.583000, qreg_0[0])
subcirc3.s(qreg_0[0])
subcirc3.s(qreg_0[1])
subcirc3.rz(0.343000, qreg_0[0])
subcirc3.s(qreg_0[0])
...
main_circ.append(subcirc2,[qreg_2[0],qreg_3[0],0,qreg_0[1],qreg_0[0]])
main_circ.append(subcirc2,[qreg_0[0],qreg_3[0],0,qreg_2[0],qreg_0[1]])
main_circ.rz(-0.332000, qreg_0[1])
main_circ.rz(-0.116000, qreg_3[0])
main_circ.rz(0.697000, qreg_2[0])
main_circ.append(subcirc2,[qreg_0[0],qreg_0[1],qreg_3[0],0,qreg_2[0]])
main_circ.s(qreg_0[1])
main_circ.append(subcirc2,[0,qreg_3[0],qreg_0[0],qreg_0[1],qreg_2[0]])
main_circ.z(qreg_3[0])
main_circ.z(qreg_0[1])
main_circ.append(subcirc3,[qreg_0[1],qreg_3[0],qreg_0[0],0])
main_circ.rz(param_1, qreg_0[0])
main_circ.append(subcirc2,[qreg_0[1],qreg_3[0],qreg_2[0],qreg_0[0],0])
main_circ.rz(-0.468000, qreg_3[0])
main_circ.s(0)
...
bindings = {param_0: -0.555000, param_1: -0.712000, param_3: -0.525000, }

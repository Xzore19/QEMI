...
with main_circ.if_test((creg_1[0],0)) as else_2:
	...
	with main_circ.switch(creg_1[0]) as case_1:
		with case_1(0):
			...
			main_circ.s(2)
			main_circ.append(subcirc1,[3,qreg_1[0],2,qreg_0[0]])
		with case_1(1):
			main_circ.x(2)
			main_circ.rz(0.657000, 1)
			main_circ.s(1)
			main_circ.x(0)
with else_2:
	main_circ.measure(qreg_0[0], creg_1[0])
	with main_circ.if_test((creg_1[0],0)) as else_1:
		main_circ.append(subcirc0,[2,3,qreg_1[0],1])
	with else_1:
		main_circ.rz(param_0, 2)
		main_circ.s(3)
		main_circ.rz(param_3, qreg_0[0])
		main_circ.append(subcirc0,[0,1,qreg_1[0],qreg_0[0]])
...
with main_circ.switch(creg_0[0]) as case_2:
	...
	with case_2(1):
		...
		with main_circ.if_test((creg_0[0],0)):
			main_circ.id(qreg_0[0])
		main_circ.id(1)
bindings = {param_0: 0.617000, param_2: -0.038000, param_3: 0.011000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1524")

...
subcirc0.u(0,0,-0.967000, qreg_1[2])
subcirc0.z(qreg_1[0])
subcirc0.h(qreg_1[0])
subcirc0.cz(qreg_0[0],qreg_1[0])
subcirc0.u(0,0,0.736000, qreg_1[1])
...
subcirc1.z(qreg_0[2])
subcirc1.u(0,0,0.860000, qreg_3[0])
subcirc1.cz(qreg_3[0],qreg_0[0])
subcirc1.z(qreg_0[0])
subcirc1.u(0,0,0.702000, qreg_3[0])
...
# Adding creg resources 
subcirc3.u(0,0,0.266000, qreg_1[0])
subcirc3.z(qreg_3[0])
subcirc3.u(0,0,-0.735000, qreg_3[0])
subcirc3.u(0,0,-0.306000, qreg_0[0])
...
subcirc4.h(qreg_0[1])
subcirc4.h(qreg_0[1])
subcirc4.u(0,0,-0.472000, qreg_3[0])
subcirc4.h(qreg_0[0])
...
run_on_simulator(main_circ, "1833")

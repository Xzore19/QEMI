...
subcirc2.z(qreg_0[1])
subcirc2.rz(0.659000, qreg_0[0])
subcirc2.rz(0.410000, qreg_2[1])
	...
	with case_3(1):
		...
		with else_2:
			...
			with main_circ.if_test((creg_0[0],0)) as else_1:
				...
				main_circ.rz(0.460000, qreg_0[2])
			with else_1:
		...
		with main_circ.switch(creg_0[1]) as case_2:
			...
			with case_2(1):
				...
				with main_circ.if_test((creg_0[0],0)):
					...
					main_circ.rz(-0.814000, qreg_0[2])
...
bindings = {param_0: -0.796000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1215")

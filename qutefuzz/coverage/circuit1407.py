...
subcirc0.u(pi/2,0.814000,0.864000, qreg_0[0])
subcirc0.x(qreg_0[0])
subcirc0.x(qreg_1[2])
...
with main_circ.switch(creg_1[0]) as case_4:
	with case_4(0):
		main_circ.u(0.788000,-0.683000,param_1, qreg_0[3])
		...
		with main_circ.if_test((creg_1[0],0)) as else_3:
			...
			with main_circ.if_test((creg_1[0],0)):
				...
				with main_circ.switch(creg_0[0]) as case_1:
					...
					with case_1(1):
						main_circ.u(pi/2,0.610000,param_1, qreg_0[0])
						main_circ.x(qreg_0[0])
						main_circ.u(param_1,param_0,-0.724000, qreg_0[2])
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			with main_circ.switch(creg_1[0]) as case_2:
				with case_2(0):
					...
					with else_1:
						main_circ.u(pi/2,0.132000,-0.917000, qreg_0[1])
						main_circ.x(qreg_0[0])
				with case_2(1):
					main_circ.measure(qreg_0[1], creg_0[0])
					with main_circ.switch(creg_0[0]) as case_1:
						with case_1(0):
							main_circ.u(param_1,0.363000,-0.186000, qreg_0[3])
							main_circ.cz(qreg_0[2],qreg_0[0])
							main_circ.u(0.690000,param_0,param_0, qreg_0[1])
							main_circ.u(pi/2,param_1,-0.093000, qreg_0[2])
						with case_1(1):
							main_circ.x(qreg_0[1])
							main_circ.u(-0.432000,-0.686000,param_0, qreg_0[3])
							main_circ.u(param_1,param_0,param_1, qreg_0[3])
	...
	with main_circ.if_test((creg_1[0],0)) as else_3:
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			...
			with main_circ.if_test((creg_1[0],0)) as else_1:
				main_circ.u(param_1,-0.707000,param_1, qreg_0[2])
			with else_1:
		...
		with else_2:
			...
			with main_circ.if_test((creg_0[0],0)) as else_1:
				...
				main_circ.cz(qreg_0[1],qreg_0[2])
				main_circ.cz(qreg_0[3],qreg_0[2])
				main_circ.u(param_1,-0.826000,param_1, qreg_0[0])
			with else_1:
		...
		with main_circ.switch(creg_0[0]) as case_2:
			with case_2(0):
				...
				with main_circ.if_test((creg_1[0],0)) as else_1:
					main_circ.cz(qreg_0[2],qreg_0[1])
					main_circ.cz(qreg_0[1],qreg_0[3])
					main_circ.u(param_1,-0.519000,param_1, qreg_0[2])
					main_circ.append(subcirc0,[qreg_0[0],qreg_0[3],qreg_0[1],qreg_0[2]])
				with else_1:
					main_circ.u(-0.102000,0.385000,param_1, qreg_0[3])
...
with else_4:
	...
	with main_circ.if_test((creg_1[0],0)):
		...
		main_circ.id(qreg_0[3])
	main_circ.id(qreg_0[3])
bindings = {param_0: 0.560000, param_1: 0.928000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1407", "CommutationAnalysis")

...
subcirc3.x(qreg_1[2])
subcirc3.cx(qreg_1[2],qreg_1[1])
subcirc3.cx(qreg_1[2],qreg_1[0])
subcirc3.cx(qreg_1[1],qreg_1[2])
...
with main_circ.switch(creg_0[1]) as case_1:
	with case_1(0):
		main_circ.append(subcirc2,[qreg_1[0],qreg_1[2],qreg_1[1],qreg_0[0]])
	with case_1(1):
		main_circ.y(qreg_0[0])
		main_circ.append(subcirc3,[qreg_1[0],qreg_0[0],1,qreg_1[1]])
main_circ.measure(qreg_1[2], creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.append(subcirc0,[0,qreg_1[0],qreg_1[1],qreg_1[2]])
with else_1:
...
with main_circ.switch(creg_0[0]) as case_1:
	with case_1(0):
		...
		main_circ.append(subcirc3,[0,qreg_1[2],qreg_0[0],qreg_1[0]])
	with case_1(1):
		main_circ.append(subcirc3,[1,qreg_1[1],0,qreg_1[0]])
main_circ.append(subcirc0,[1,qreg_1[1],qreg_1[2],0])
...
with main_circ.switch(creg_0[1]) as case_1:
	...
	with case_1(1):
		...
		main_circ.x(0)
		main_circ.append(subcirc0,[1,qreg_1[0],qreg_1[1],qreg_1[2]])
main_circ.measure(qreg_1[2], creg_0[1])
with main_circ.if_test((creg_0[1],0)):
	main_circ.append(subcirc3,[qreg_1[1],1,qreg_0[0],qreg_1[0]])
main_circ.measure(qreg_1[2], creg_0[1])
with main_circ.switch(creg_0[1]) as case_1:
	with case_1(0):
		main_circ.y(1)
...
run_on_simulator(main_circ, "601")

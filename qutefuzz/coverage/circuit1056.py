...
main_circ.rx(-0.082000, qreg_0[0])
...
main_circ.rx(0.008000, qreg_0[2])
main_circ.h(qreg_3[0])
main_circ.cy(qreg_0[1],qreg_0[2])
...
main_circ.rx(0.796000, qreg_0[1])
main_circ.h(qreg_0[0])
main_circ.append(subcirc2,[qreg_0[2],qreg_0[1],qreg_0[0],qreg_3[0]])
bindings = {param_0: 0.009000, param_2: 0.264000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "1056")

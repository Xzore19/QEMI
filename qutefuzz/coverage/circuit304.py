...
main_circ.h(qreg_1[2])
main_circ.h(qreg_1[1])
main_circ.append(subcirc2,[qreg_1[0],qreg_0[0],qreg_1[1],qreg_1[2]])
main_circ.append(subcirc3,[qreg_1[0],qreg_1[1],qreg_0[0],qreg_1[2]])
...
run_routing_simulation(main_circ, "304")

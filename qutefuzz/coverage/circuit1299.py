...
subcirc0.u(pi/2,-0.916000,0.059000, qreg_0[1])
...
# Adding creg resources 
subcirc1.x(qreg_0[0])
subcirc1.u(pi/2,0.698000,0.347000, qreg_3[0])
subcirc1.x(qreg_0[1])
subcirc1.z(qreg_2[0])
subcirc1.x(qreg_0[1])
...
subcirc2.x(qreg_0[2])
subcirc2.u(pi/2,0.430000,-0.809000, qreg_0[3])
...
subcirc3.z(qreg_2[0])
subcirc3.z(qreg_2[0])
subcirc3.u(pi/2,0.196000,-0.354000, qreg_3[0])
...
with main_circ.switch(creg_1[0]) as case_1:
	...
	with case_1(1):
		main_circ.append(subcirc3,[qreg_0[1],qreg_2[1],qreg_2[0],qreg_0[0]])
main_circ.measure(qreg_2[0], creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.append(subcirc3,[qreg_0[0],qreg_2[0],qreg_2[1],qreg_0[1]])
with else_1:
...
with main_circ.switch(creg_0[0]) as case_1:
	...
	with case_1(1):
		main_circ.u(pi/2,param_4,param_3, qreg_0[0])
...
with main_circ.switch(creg_1[0]) as case_1:
	...
	with case_1(1):
		main_circ.barrier(qreg_0[0])
bindings = {param_3: -0.605000, param_4: -0.731000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1299")

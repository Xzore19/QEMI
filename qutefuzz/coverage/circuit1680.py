...
subcirc0.ry(0.797000, qreg_0[3])
subcirc0.ry(0.762000, qreg_0[3])
subcirc0.cx(qreg_0[0],qreg_0[1])
subcirc0.cz(qreg_0[2],qreg_0[3])
subcirc0.u(0,0,-0.027000, qreg_0[0])
...
# Adding creg resources 
subcirc1.u(0,0,0.655000, qreg_1[0])
subcirc1.cx(qreg_3[0],qreg_1[0])
subcirc1.ry(0.716000, qreg_2[0])
subcirc1.u(0,0,0.546000, qreg_2[0])
subcirc1.ry(-0.830000, qreg_2[0])
...
main_circ.ry(-0.477000, 1)
main_circ.u(0,param_0,0.379000, 0)
main_circ.cz(0,qreg_1[0])
main_circ.ry(param_2, qreg_2[0])
main_circ.cx(qreg_0[0],qreg_2[0])
main_circ.append(subcirc0,[0,qreg_1[0],1,qreg_2[0],qreg_0[0],qreg_3[0]])
main_circ.cz(qreg_3[0],qreg_1[0])
main_circ.append(subcirc0,[qreg_3[0],qreg_1[0],qreg_0[0],0,qreg_2[0],1])
main_circ.ry(param_1, qreg_3[0])
main_circ.cz(qreg_2[0],qreg_0[0])
main_circ.cz(1,qreg_3[0])
main_circ.cz(0,qreg_2[0])
main_circ.ry(-0.576000, qreg_3[0])
main_circ.u(0,0,param_0, 0)
main_circ.cx(1,qreg_1[0])
main_circ.cz(qreg_2[0],qreg_0[0])
main_circ.cx(0,qreg_1[0])
main_circ.ry(-0.147000, qreg_1[0])
bindings = {param_0: 0.065000, param_1: -0.315000, param_2: -0.801000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "1680")

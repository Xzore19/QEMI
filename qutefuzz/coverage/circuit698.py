...
subcirc1.u(pi/2,-0.779000,0.865000, qreg_0[0])
subcirc1.u(pi/2,0.552000,0.877000, qreg_0[0])
...
with main_circ.if_test((creg_1[0],0)) as else_4:
	main_circ.u(pi/2,-0.908000,-0.600000, qreg_0[1])
			...
			with main_circ.switch(creg_0[0]) as case_2:
				...
				with case_2(1):
					...
					with main_circ.switch(creg_1[0]) as case_1:
						...
						with case_1(1):
							main_circ.u(param_3,param_4,-0.373000, qreg_2[0])
							main_circ.id(qreg_0[0])
		with case_3(1):
			main_circ.measure(qreg_2[1], creg_1[0])
			with main_circ.if_test((creg_1[0],0)) as else_2:
				main_circ.append(subcirc1,[qreg_2[1],qreg_2[0],qreg_0[1],qreg_0[0]])
			with else_2:
				...
				main_circ.measure(qreg_2[1], creg_1[0])
				with main_circ.if_test((creg_1[0],0)):
					main_circ.append(subcirc1,[qreg_2[0],qreg_0[1],qreg_0[0],qreg_2[1]])
with else_4:
	main_circ.measure(qreg_2[0], creg_1[0])
	...
	with else_3:
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			...
			with else_1:
				main_circ.u(param_4,param_1,param_0, qreg_0[0])
				main_circ.y(qreg_2[1])
				main_circ.y(qreg_2[0])
				main_circ.y(qreg_2[1])
		with else_2:
			...
			with main_circ.switch(creg_1[0]) as case_1:
				...
				with case_1(1):
					...
					main_circ.u(param_0,param_4,0.268000, qreg_2[0])
	...
	with main_circ.switch(creg_1[0]) as case_3:
		with case_3(0):
			...
			with else_2:
				...
				with main_circ.switch(creg_0[0]) as case_1:
					with case_1(0):
						main_circ.u(pi/2,param_1,-0.927000, qreg_2[0])
...
with else_4:
	...
	with main_circ.if_test((creg_1[0],0)):
		...
		main_circ.barrier(qreg_0[0])
	main_circ.id(qreg_2[1])
bindings = {param_0: -0.521000, param_1: 0.048000, param_3: 0.754000, param_4: 0.758000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "698", "CommutationAnalysis")

...
# Adding creg resources 
subcirc2.ry(0.125000, qreg_0[1])
subcirc2.ry(0.115000, qreg_3[0])
subcirc2.cy(qreg_0[1],qreg_0[0])
subcirc2.y(qreg_3[0])
subcirc2.ry(-0.661000, qreg_2[0])
...
# Adding creg resources 
subcirc3.ry(0.699000, qreg_0[1])
subcirc3.h(qreg_0[0])
subcirc3.ry(0.160000, qreg_0[0])
subcirc3.ry(0.439000, qreg_0[0])
subcirc3.y(qreg_0[1])
...
subcirc4.h(qreg_0[1])
subcirc4.h(qreg_0[0])
subcirc4.ry(-0.160000, qreg_0[1])
subcirc4.ry(0.778000, qreg_2[0])
	...
	with case_2(0):
		...
		with main_circ.switch(creg_1[0]) as case_1:
			...
			with case_1(1):
				...
				main_circ.append(subcirc4,[qreg_0[3],0,qreg_0[2],qreg_0[0]])
	with case_2(1):
		main_circ.measure(qreg_0[3], creg_0[0])
...
bindings = {param_5: 0.926000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "703", "RemoveDiagonalGatesBeforeMeasure")

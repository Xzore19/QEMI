...
subcirc0.rx(-0.547000, qreg_0[0])
subcirc0.rx(-0.745000, qreg_2[0])
subcirc0.rx(-0.407000, qreg_2[0])
subcirc0.s(qreg_0[0])
...
with main_circ.switch(creg_0[0]) as case_3:
	...
	with case_3(1):
		...
		main_circ.id(0)
main_circ.s(3)
bindings = {param_3: -0.993000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "996", "NormalizeRXAngle")

...
subcirc0.ry(0.562000, qreg_0[2])
subcirc0.s(qreg_0[2])
subcirc0.cx(qreg_0[0],qreg_3[0])
subcirc0.cx(qreg_0[0],qreg_3[0])
subcirc0.s(qreg_3[0])
subcirc0.ry(0.335000, qreg_0[1])
...
with main_circ.if_test((creg_0[1],0)):
	...
	with else_3:
		...
		with main_circ.if_test((creg_0[1],0)):
			...
			main_circ.barrier(3)
		main_circ.barrier(1)
bindings = {param_1: 0.771000, param_2: 0.843000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1272")

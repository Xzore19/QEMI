...
with else_4:
	...
	with else_3:
		...
		with main_circ.if_test((creg_1[0],0)) as else_2:
			...
			with main_circ.switch(creg_0[0]) as case_1:
				with case_1(0):
					main_circ.rx(-0.293000, 2)
					main_circ.ry(param_3, 0)
					main_circ.h(1)
					main_circ.rx(-0.851000, 0)
				with case_1(1):
		...
		with else_2:
			...
			with main_circ.switch(creg_0[0]) as case_1:
				...
				with case_1(1):
					main_circ.barrier(2)
			main_circ.barrier(2)
bindings = {param_0: 0.902000, param_1: 0.787000, param_2: -0.051000, param_3: 0.462000, param_4: -0.526000, param_5: -0.019000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1705")

		...
		with main_circ.switch(creg_0[1]) as case_2:
			with case_2(0):
				...
				with main_circ.switch(creg_0[1]) as case_1:
					with case_1(0):
						...
						main_circ.append(subcirc3,[qreg_0[0],qreg_0[3],qreg_0[2],qreg_0[1]])
					with case_1(1):
			...
			with case_2(1):
				...
				with main_circ.if_test((creg_0[0],0)):
					...
					main_circ.append(subcirc0,[qreg_0[2],qreg_0[3],0,qreg_0[1],qreg_0[0]])
with else_4:
	main_circ.measure(qreg_0[3], creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
	...
	with case_4(0):
		...
		with main_circ.if_test((creg_0[1],0)):
			...
			with main_circ.if_test((creg_0[1],0)):
				main_circ.measure(qreg_0[3], creg_0[0])
				with main_circ.if_test((creg_0[0],0)):
					main_circ.append(subcirc0,[0,qreg_0[0],qreg_0[3],qreg_0[2],qreg_0[1]])
	with case_4(1):
...
with main_circ.if_test((creg_0[1],0)) as else_4:
	...
	with main_circ.if_test((creg_0[1],0)) as else_3:
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			with main_circ.if_test((creg_0[1],0)):
				main_circ.h(qreg_0[3])
				main_circ.ry(-0.068000, qreg_0[1])
				main_circ.id(qreg_0[1])
		...
		with main_circ.switch(creg_0[1]) as case_2:
			...
			with case_2(1):
				main_circ.measure(qreg_0[0], creg_0[0])
				with main_circ.if_test((creg_0[0],0)):
					main_circ.append(subcirc0,[qreg_0[3],qreg_0[0],qreg_0[1],0,qreg_0[2]])
	with else_3:
		main_circ.measure(qreg_0[1], creg_0[0])
...
with else_4:
	...
	with main_circ.switch(creg_0[0]) as case_3:
		...
		with case_3(1):
			...
			main_circ.barrier(qreg_0[3])
	main_circ.barrier(qreg_0[2])
bindings = {param_0: -0.108000, param_1: -0.228000, param_2: -0.042000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1060", "CommutationAnalysis")

...
# Adding creg resources 
subcirc1.rx(-0.279000, qreg_0[0])
subcirc1.rx(-0.511000, qreg_0[1])
subcirc1.s(qreg_3[0])
subcirc1.s(qreg_0[1])
		...
		with case_3(1):
			...
			with main_circ.if_test((creg_0[0],0)) as else_2:
				...
				with main_circ.if_test((creg_0[0],0)):
					main_circ.s(0)
					main_circ.s(qreg_0[0])
					main_circ.rx(-0.700000, qreg_0[0])
					main_circ.s(1)
			with else_2:
				main_circ.measure(1, creg_1[0])
				with main_circ.if_test((creg_1[0],0)) as else_1:
...
with main_circ.switch(creg_1[0]) as case_4:
	...
	with case_4(1):
		...
		with main_circ.if_test((creg_1[0],0)):
			...
			main_circ.id(3)
		main_circ.barrier(2)
bindings = {param_0: -0.053000, param_2: 0.203000, param_3: -0.016000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "392")

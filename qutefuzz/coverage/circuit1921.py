...
subcirc0.h(qreg_1[0])
subcirc0.rz(0.693000, qreg_1[1])
subcirc0.z(qreg_0[0])
subcirc0.rz(-0.416000, qreg_0[0])
subcirc0.z(qreg_0[0])
...
with main_circ.switch(creg_0[0]) as case_2:
	with case_2(0):
		...
		with main_circ.switch(creg_1[0]) as case_1:
			with case_1(0):
				...
				main_circ.u(param_3,param_0,0.259000, qreg_0[2])
				main_circ.rz(0.326000, qreg_0[2])
				main_circ.append(subcirc0,[qreg_0[0],qreg_3[0],qreg_0[2],qreg_0[1]])
			with case_1(1):
	...
	with case_2(1):
		...
		with main_circ.if_test((creg_0[0],0)) as else_1:
			main_circ.z(qreg_0[2])
			main_circ.u(param_4,param_0,param_1, qreg_0[2])
		...
		with main_circ.switch(creg_1[0]) as case_1:
			...
			with case_1(1):
				main_circ.barrier(qreg_3[0])
		main_circ.id(qreg_3[0])
bindings = {param_0: 0.456000, param_1: -0.696000, param_2: 0.037000, param_3: 0.685000, param_4: -0.278000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1921", "CXCancellation")

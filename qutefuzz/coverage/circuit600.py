...
# Adding creg resources 
subcirc2.rx(0.517000, qreg_3[0])
subcirc2.z(qreg_0[0])
subcirc2.y(qreg_0[0])
subcirc2.cz(qreg_0[2],qreg_0[1])
subcirc2.rx(0.987000, qreg_0[0])
...
with main_circ.switch(creg_0[0]) as case_1:
	...
	with case_1(1):
		...
		main_circ.append(subcirc1,[qreg_3[0],qreg_0[1],qreg_0[0],qreg_2[0]])
main_circ.measure(qreg_3[0], creg_0[0])
with main_circ.switch(creg_0[0]) as case_1:
	with case_1(0):
		main_circ.cz(qreg_0[1],qreg_3[0])
		main_circ.append(subcirc1,[qreg_3[0],qreg_2[0],qreg_0[1],qreg_0[0]])
	with case_1(1):
...
with main_circ.if_test((creg_0[1],0)) as else_1:
	...
	main_circ.append(subcirc1,[qreg_2[0],qreg_0[0],qreg_3[0],qreg_0[1]])
with else_1:
...
with main_circ.if_test((creg_0[0],0)):
	main_circ.y(qreg_3[0])
	main_circ.barrier(qreg_0[1])
bindings = {param_5: 0.542000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "600", "InverseCancellation")

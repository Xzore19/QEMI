...
subcirc1.rx(-0.342000, qreg_0[0])
subcirc1.rx(-0.284000, qreg_0[0])
subcirc1.x(qreg_0[2])
...
with main_circ.if_test((creg_0[0],0)):
	main_circ.y(0)
	main_circ.rx(-0.347000, qreg_0[2])
...
bindings = {param_2: 0.596000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "659", "Optimize1qGatesSimpleCommutation")

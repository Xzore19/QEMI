...
subcirc2.rx(0.333000, qreg_1[2])
subcirc2.cy(qreg_0[0],qreg_1[0])
subcirc2.cx(qreg_1[1],qreg_1[0])
subcirc2.rx(0.791000, qreg_1[2])
...
with main_circ.switch(creg_0[0]) as case_1:
	with case_1(0):
		...
		main_circ.rx(-0.085000, qreg_0[1])
...
with main_circ.if_test((creg_0[0],0)):
	...
	main_circ.barrier(qreg_0[1])
bindings = {param_0: -0.842000, param_3: 0.145000, param_4: 0.818000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "263")

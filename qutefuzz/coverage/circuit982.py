...
main_circ.append(subcirc2,[qreg_1[1],qreg_0[0],1,qreg_1[0],qreg_1[2]])
main_circ.append(subcirc1,[1,qreg_1[2],qreg_1[1],qreg_1[0]])
main_circ.append(subcirc3,[qreg_1[2],1,qreg_1[1],0,qreg_1[0]])
main_circ.append(subcirc3,[qreg_0[0],qreg_1[1],qreg_1[2],1,qreg_1[0]])
main_circ.h(0)
main_circ.cy(qreg_1[2],1)
main_circ.append(subcirc1,[qreg_1[2],qreg_0[0],qreg_1[0],1])
main_circ.x(qreg_1[0])
main_circ.x(1)
main_circ.append(subcirc2,[qreg_1[1],qreg_1[0],qreg_1[2],qreg_0[0],0])
main_circ.cy(1,qreg_1[2])
main_circ.append(subcirc3,[1,qreg_1[2],qreg_1[0],qreg_1[1],0])
main_circ.h(1)
...
run_routing_simulation(main_circ, "982")

...
subcirc0.y(qreg_0[1])
subcirc0.rx(0.892000, qreg_0[0])
subcirc0.rz(-0.018000, qreg_0[3])
...
with else_1:
	main_circ.y(1)
	main_circ.id(1)
bindings = {param_1: 0.428000, param_2: 0.341000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1686")

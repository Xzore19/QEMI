			...
			with case_3(0):
				...
				with main_circ.if_test((creg_0[0],0)):
					...
					with main_circ.switch(creg_0[1]) as case_1:
						with case_1(0):
							main_circ.rz(-0.802000, qreg_1[1])
							main_circ.s(qreg_3[0])
							main_circ.s(qreg_1[1])
							main_circ.rz(-0.618000, qreg_1[0])
						with case_1(1):
							main_circ.cy(qreg_1[1],0)
							main_circ.s(qreg_1[1])
							main_circ.rz(0.348000, qreg_3[0])
							main_circ.s(0)
			with case_3(1):
				main_circ.measure(0, creg_0[0])
			...
			with case_3(0):
				...
				with else_2:
					...
					with main_circ.switch(creg_0[0]) as case_1:
						with case_1(0):
							main_circ.rz(-0.376000, qreg_3[0])
				...
				with main_circ.switch(creg_0[1]) as case_2:
					with case_2(0):
						...
						with main_circ.if_test((creg_0[1],0)):
							main_circ.cy(qreg_0[0],qreg_1[0])
							main_circ.cy(qreg_1[0],0)
							main_circ.rz(-0.464000, qreg_1[1])
						main_circ.measure(qreg_1[0], creg_0[0])
...
bindings = {param_1: -0.930000, param_3: -0.955000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "219", "NormalizeRXAngle")

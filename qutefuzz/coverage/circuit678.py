...
main_circ.append(subcirc3,[1,qreg_0[0],2,0,3])
main_circ.append(subcirc0,[qreg_0[1],0,2,3])
...
main_circ.s(2)
main_circ.s(2)
main_circ.append(subcirc1,[3,2,1,qreg_0[1]])
main_circ.cz(0,2)
...
main_circ.z(1)
main_circ.append(subcirc1,[qreg_0[1],1,qreg_0[0],2])
main_circ.s(0)
main_circ.s(0)
bindings = {}

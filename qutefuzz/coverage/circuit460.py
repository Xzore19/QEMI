...
subcirc0.rx(0.780000, qreg_0[1])
subcirc0.cx(qreg_0[0],qreg_0[1])
subcirc0.x(qreg_0[1])
subcirc0.rx(0.278000, qreg_3[0])
...
# Adding creg resources 
subcirc1.rx(0.780000, qreg_1[2])
subcirc1.x(qreg_1[1])
subcirc1.rx(-0.030000, qreg_0[0])
subcirc1.s(qreg_0[0])
subcirc1.rx(-0.127000, qreg_0[0])
...
# Adding creg resources 
subcirc4.s(qreg_0[2])
subcirc4.rx(-0.233000, qreg_0[1])
subcirc4.s(qreg_0[1])
subcirc4.rx(-0.895000, qreg_3[0])
subcirc4.rx(0.103000, qreg_0[2])
		...
		with else_2:
			...
			with main_circ.switch(creg_0[1]) as case_1:
				with case_1(0):
					...
					main_circ.append(subcirc3,[2,1,0,qreg_0[0],3])
				with case_1(1):
					main_circ.cx(0,3)
					main_circ.cx(3,1)
...
with else_4:
	...
	with main_circ.if_test((creg_0[0],0)):
		...
		main_circ.id(qreg_0[0])
	main_circ.barrier(1)
bindings = {param_0: 0.633000, param_1: 0.653000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "460")

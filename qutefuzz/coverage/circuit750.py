...
with main_circ.if_test((creg_0[0],0)) as else_2:
	...
	with main_circ.if_test((creg_0[0],0)) as else_1:
		main_circ.rz(0.327000, qreg_0[2])
...
with else_2:
	...
	with else_1:
		main_circ.x(0)
		main_circ.rz(-0.668000, qreg_0[1])
...
with else_2:
	...
	with main_circ.if_test((creg_1[0],0)):
		main_circ.rz(0.849000, qreg_0[0])
	...
	with case_2(1):
		...
		with main_circ.switch(creg_1[0]) as case_1:
			...
			with case_1(1):
				...
				main_circ.barrier(0)
bindings = {param_0: 0.512000, param_1: 0.534000, param_2: -0.172000, param_3: 0.077000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "750", "CommutationAnalysis")

...
main_circ.rz(-0.776000, qreg_2[1])
			...
			with case_3(0):
				...
				with main_circ.if_test((creg_1[0],0)):
					...
					with main_circ.if_test((creg_1[0],0)) as else_1:
						...
						main_circ.ry(0.185000, qreg_0[1])
		...
		with main_circ.if_test((creg_1[0],0)):
			...
			with main_circ.if_test((creg_1[0],0)):
				...
				with main_circ.switch(creg_1[0]) as case_1:
					with case_1(0):
						main_circ.rz(0.625000, qreg_0[1])
						main_circ.ry(-0.034000, qreg_0[1])
						main_circ.rz(param_0, qreg_0[1])
						main_circ.cx(qreg_0[0],qreg_2[0])
					with case_1(1):
						main_circ.ry(param_0, 0)
						main_circ.x(qreg_0[0])
						main_circ.ry(-0.410000, qreg_2[0])
						main_circ.rz(-0.091000, 1)
main_circ.measure(qreg_0[0], creg_0[0])
			...
			with main_circ.if_test((creg_0[0],0)):
				...
				with main_circ.switch(creg_0[0]) as case_1:
					with case_1(0):
						...
						main_circ.rz(0.166000, qreg_2[1])
					with case_1(1):
	...
	with case_4(1):
		...
		with main_circ.if_test((creg_1[0],0)):
			...
			with main_circ.if_test((creg_0[0],0)) as else_2:
				main_circ.measure(qreg_0[0], creg_1[0])
				with main_circ.if_test((creg_1[0],0)):
					main_circ.rz(0.663000, qreg_0[1])
		...
		with main_circ.switch(creg_0[0]) as case_3:
			...
			with case_3(1):
				...
				main_circ.id(qreg_0[0])
		main_circ.id(qreg_2[0])
bindings = {param_0: 0.809000, param_1: 0.400000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "194")

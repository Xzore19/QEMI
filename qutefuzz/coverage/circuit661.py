...
with main_circ.switch(creg_1[0]) as case_2:
	...
	with case_2(1):
		...
		main_circ.ry(-0.390000, qreg_3[0])
		main_circ.measure(qreg_2[0], creg_1[0])
		with main_circ.if_test((creg_1[0],0)):
			main_circ.append(subcirc3,[qreg_0[0],qreg_3[0],qreg_0[1],qreg_2[0]])
main_circ.measure(0, creg_1[0])
with main_circ.if_test((creg_1[0],0)) as else_2:
	main_circ.measure(qreg_0[1], creg_0[0])
	with main_circ.if_test((creg_0[0],0)) as else_1:
		main_circ.append(subcirc3,[0,qreg_2[0],qreg_0[0],qreg_0[1]])
...
with else_2:
	...
	with else_1:
		main_circ.ry(0.487000, qreg_0[1])
		main_circ.append(subcirc3,[0,qreg_0[1],qreg_3[0],qreg_0[0]])
main_circ.measure(qreg_0[0], creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_2:
	main_circ.measure(qreg_0[1], creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
		main_circ.z(qreg_2[0])
		main_circ.append(subcirc2,[qreg_2[0],qreg_0[1],qreg_0[0],0])
with else_2:
	main_circ.measure(qreg_0[1], creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
...
with else_2:
	...
	with main_circ.switch(creg_1[0]) as case_1:
		...
		with case_1(1):
			main_circ.append(subcirc3,[qreg_0[0],qreg_3[0],qreg_2[0],qreg_0[1]])
...
with main_circ.switch(creg_0[0]) as case_2:
	...
	with case_2(1):
		...
		with else_1:
			main_circ.z(qreg_2[0])
			main_circ.append(subcirc3,[qreg_0[1],0,qreg_0[0],qreg_2[0]])
main_circ.measure(0, creg_0[0])
with main_circ.switch(creg_0[0]) as case_2:
	with case_2(0):
		main_circ.measure(qreg_2[0], creg_1[0])
	...
	with case_2(1):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			...
			with case_1(1):
				main_circ.barrier(qreg_3[0])
		main_circ.barrier(0)
bindings = {param_3: 0.384000, param_4: 0.693000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "661")

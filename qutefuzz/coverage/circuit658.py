...
# Adding creg resources 
subcirc2.rz(0.898000, qreg_0[0])
subcirc2.cy(qreg_1[1],qreg_0[0])
subcirc2.y(qreg_0[0])
subcirc2.y(qreg_1[1])
subcirc2.cy(qreg_1[1],qreg_0[0])
subcirc2.rz(0.423000, qreg_1[0])
...
# Adding creg resources 
subcirc3.rz(-0.554000, qreg_0[1])
subcirc3.rz(-0.904000, qreg_0[0])
subcirc3.y(qreg_3[0])
...
with main_circ.if_test((creg_0[0],0)) as else_3:
	main_circ.append(subcirc2,[0,2,qreg_0[0],1])
with else_3:
...
with main_circ.switch(creg_1[0]) as case_3:
	with case_3(0):
		main_circ.append(subcirc3,[1,3,0,qreg_0[0]])
	with case_3(1):
	...
	with else_2:
		...
		with main_circ.switch(creg_1[0]) as case_1:
			...
			with case_1(1):
				main_circ.barrier(qreg_0[0])
		main_circ.barrier(0)
bindings = {param_1: -0.609000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "658", "CommutativeInverseCancellation")

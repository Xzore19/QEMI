...
subcirc1.u(0,0,0.467000, qreg_0[3])
		...
		with else_2:
			...
			with main_circ.switch(creg_0[0]) as case_1:
				...
				with case_1(1):
					...
					main_circ.u(param_0,0,-0.018000, qreg_0[0])
...
with else_3:
	main_circ.id(2)
bindings = {param_0: 0.107000, param_2: 0.863000, param_3: 0.115000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "224", "Optimize1qGatesDecomposition")

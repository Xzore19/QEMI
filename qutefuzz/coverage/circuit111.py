...
with main_circ.if_test((creg_0[0],0)):
	...
	with main_circ.if_test((creg_1[0],0)):
		main_circ.append(subcirc0,[3,qreg_1[0],0,qreg_0[0],1])
...
with main_circ.switch(creg_0[0]) as case_3:
		...
		with main_circ.switch(creg_1[0]) as case_2:
			with case_2(0):
				...
				with main_circ.switch(creg_0[0]) as case_1:
					...
					with case_1(1):
						main_circ.append(subcirc0,[1,0,qreg_1[0],2,3])
			with case_2(1):
				main_circ.measure(2, creg_1[0])
				with main_circ.if_test((creg_1[0],0)) as else_1:
					main_circ.x(0)
					main_circ.append(subcirc1,[qreg_0[0],qreg_1[0],2,3])
				with else_1:
	...
	with case_3(1):
		...
		with main_circ.if_test((creg_1[0],0)) as else_2:
			main_circ.ry(0.650000, 1)
		with else_2:
			main_circ.measure(1, creg_1[0])
			with main_circ.switch(creg_1[0]) as case_1:
				with case_1(0):
					main_circ.append(subcirc0,[2,1,qreg_1[0],qreg_0[0],0])
				with case_1(1):
					main_circ.z(0)
					main_circ.x(3)
...
with else_3:
	...
	with else_2:
		...
		main_circ.barrier(qreg_1[0])
	main_circ.barrier(0)
bindings = {param_1: 0.790000, param_4: 0.403000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "111")

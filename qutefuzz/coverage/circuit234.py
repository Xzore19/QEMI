...
with main_circ.switch(creg_0[0]) as case_2:
	with case_2(0):
		...
		with main_circ.switch(creg_1[0]) as case_1:
			...
			with case_1(1):
				main_circ.append(subcirc0,[0,qreg_0[1],qreg_3[0],qreg_0[0]])
	with case_2(1):
...
with else_2:
	...
	with main_circ.switch(creg_1[0]) as case_1:
		with case_1(0):
			main_circ.append(subcirc0,[qreg_2[0],0,qreg_3[0],qreg_0[0]])
		with case_1(1):
			main_circ.cx(qreg_0[1],qreg_3[0])
			main_circ.append(subcirc0,[0,qreg_0[1],qreg_2[0],qreg_3[0]])
...
with main_circ.switch(creg_1[0]) as case_2:
	with case_2(0):
		...
		with else_1:
			main_circ.append(subcirc0,[0,qreg_2[0],qreg_0[1],qreg_3[0]])
	with case_2(1):
...
run_on_simulator(main_circ, "234")

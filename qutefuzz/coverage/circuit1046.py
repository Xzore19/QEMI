...
with main_circ.if_test((creg_0[0],0)):
	...
	main_circ.z(0)
	main_circ.cx(1,3)
main_circ.append(subcirc2,[2,0,1,qreg_0[0],qreg_1[0]])
main_circ.measure(qreg_0[0], creg_0[1])
with main_circ.if_test((creg_0[1],0)):
	main_circ.append(subcirc0,[0,2,1,qreg_1[0]])
main_circ.measure(0, creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.append(subcirc1,[0,qreg_1[0],qreg_0[0],1,2])
with else_1:
	main_circ.append(subcirc0,[qreg_1[0],qreg_0[0],3,1])
main_circ.measure(qreg_0[0], creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.append(subcirc2,[0,3,qreg_0[0],1,qreg_1[0]])
with else_1:
	main_circ.z(qreg_0[0])
	main_circ.cy(qreg_0[0],2)
main_circ.measure(2, creg_0[1])
with main_circ.if_test((creg_0[1],0)):
	main_circ.append(subcirc1,[0,3,2,qreg_0[0],1])
main_circ.measure(qreg_0[0], creg_0[1])
...
with main_circ.switch(creg_0[1]) as case_1:
	with case_1(0):
		main_circ.append(subcirc2,[qreg_1[0],3,1,2,0])
	with case_1(1):
...
run_pass_on_simulator(main_circ, "1046", "CollectMultiQBlocks")

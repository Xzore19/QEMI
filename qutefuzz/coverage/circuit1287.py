...
with main_circ.if_test((creg_1[0],0)) as else_2:
	...
	with main_circ.switch(creg_1[0]) as case_1:
		with case_1(0):
			...
			main_circ.u(param_1,param_0,0.390000, qreg_3[0])
			main_circ.rx(0.580000, qreg_0[0])
			main_circ.u(0,param_0,-0.418000, qreg_0[0])
		with case_1(1):
...
with else_2:
	...
	with main_circ.switch(creg_0[0]) as case_1:
		...
		with case_1(1):
			...
			main_circ.u(0,param_1,-0.450000, qreg_0[0])
			main_circ.u(param_0,param_0,-0.156000, qreg_0[1])
...
with main_circ.switch(creg_1[0]) as case_2:
	with case_2(0):
		...
		with main_circ.switch(creg_1[0]) as case_1:
			with case_1(0):
				main_circ.rx(0.494000, qreg_2[0])
				main_circ.u(param_1,param_0,0.274000, qreg_0[1])
				main_circ.cy(qreg_2[0],qreg_3[0])
				main_circ.u(param_1,param_0,0.349000, qreg_2[0])
			with case_1(1):
				main_circ.cz(qreg_2[0],qreg_3[0])
				main_circ.cy(qreg_2[0],qreg_3[0])
				main_circ.u(param_1,0,-0.763000, qreg_2[0])
				main_circ.cz(qreg_0[1],qreg_0[0])
	with case_2(1):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			with case_1(0):
				main_circ.cy(qreg_2[0],qreg_3[0])
				main_circ.u(param_1,0,-0.616000, qreg_3[0])
				main_circ.cz(qreg_0[0],qreg_2[0])
				main_circ.cy(qreg_0[1],qreg_3[0])
			with case_1(1):
				main_circ.u(param_1,param_1,-0.534000, qreg_0[1])
				main_circ.cz(qreg_0[0],qreg_2[0])
				main_circ.u(0,0,param_1, qreg_3[0])
				main_circ.u(0,param_0,0.945000, qreg_2[0])
main_circ.measure(qreg_0[1], creg_0[0])
	...
	with case_2(0):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			...
			with case_1(1):
				main_circ.cy(qreg_0[0],qreg_0[1])
				main_circ.cz(qreg_0[0],qreg_3[0])
				main_circ.u(0,param_0,-0.136000, qreg_0[0])
				main_circ.u(0,param_1,0.157000, qreg_2[0])
	with case_2(1):
		main_circ.cz(qreg_0[0],qreg_2[0])
...
bindings = {param_0: -0.770000, param_1: -0.896000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1287")

...
def main():
    ...
    with main_circ.if_test((creg_1[0],0)) as else_2:
    	...
    	with main_circ.if_test((creg_1[0],0)):
    		...
    		main_circ.z(0)
    		main_circ.append(subcirc1,[qreg_2[1],0,qreg_2[0],qreg_0[1],qreg_0[0]])
    with else_2:
    ...
    with main_circ.if_test((creg_1[0],0)) as else_2:
    	...
    	with main_circ.if_test((creg_1[0],0)) as else_1:
    		...
    		main_circ.append(subcirc2,[qreg_2[1],0,qreg_0[1],qreg_2[0]])
    	with else_1:
    ...
    run_pass_on_simulator(main_circ, "45", "OptimizeCliffords")

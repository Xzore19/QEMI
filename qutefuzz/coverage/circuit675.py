...
subcirc0.h(qreg_0[0])
subcirc0.cz(qreg_3[0],qreg_0[0])
subcirc0.u(pi/2,-0.778000,0.963000, qreg_2[0])
...
subcirc1.u(pi/2,-0.979000,-0.847000, qreg_0[0])
subcirc1.s(qreg_2[0])
subcirc1.s(qreg_2[0])
...
# Adding creg resources 
subcirc3.u(pi/2,-0.671000,-0.987000, qreg_3[0])
subcirc3.s(qreg_0[1])
subcirc3.u(pi/2,-0.123000,-0.848000, qreg_0[1])
subcirc3.u(pi/2,0.339000,0.909000, qreg_0[2])
...
main_circ.append(subcirc3,[qreg_2[1],qreg_0[0],qreg_0[1],qreg_2[0]])
main_circ.append(subcirc3,[qreg_2[0],qreg_0[0],qreg_0[1],qreg_2[1]])
main_circ.h(qreg_2[0])
main_circ.h(qreg_2[0])
main_circ.h(qreg_0[0])
main_circ.cz(qreg_0[1],qreg_2[1])
main_circ.append(subcirc3,[qreg_0[0],qreg_2[1],qreg_0[1],qreg_2[0]])
main_circ.s(qreg_2[1])
main_circ.u(pi/2,param_2,0.026000, qreg_0[1])
...
main_circ.append(subcirc3,[qreg_0[1],qreg_2[0],qreg_0[0],qreg_2[1]])
...
main_circ.h(qreg_0[1])
main_circ.h(qreg_0[1])
bindings = {param_1: -0.202000, param_2: -0.378000, }

...
subcirc0.rx(-0.335000, qreg_0[3])
subcirc0.h(qreg_0[1])
subcirc0.cx(qreg_0[1],qreg_0[3])
subcirc0.cz(qreg_0[3],qreg_0[1])
subcirc0.rx(0.762000, qreg_0[1])
...
main_circ.rx(0.635000, qreg_2[0])
...
with main_circ.switch(creg_0[0]) as case_1:
	...
	with case_1(1):
		main_circ.append(subcirc2,[qreg_0[0],0,qreg_1[0],qreg_2[0]])
main_circ.measure(0, creg_1[0])
with main_circ.if_test((creg_1[0],0)):
	main_circ.h(qreg_0[0])
	main_circ.h(qreg_2[1])
	main_circ.append(subcirc0,[0,qreg_2[1],qreg_1[0],qreg_0[0]])
...
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.append(subcirc0,[qreg_1[0],qreg_2[0],qreg_0[0],0])
with else_1:
	main_circ.barrier(0)
main_circ.measure(0, creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_1:
...
with else_1:
	main_circ.append(subcirc0,[qreg_1[0],qreg_2[1],0,qreg_0[0]])
main_circ.append(subcirc2,[qreg_2[1],qreg_0[0],0,qreg_1[0]])
main_circ.rx(param_0, qreg_0[0])
bindings = {param_0: -0.862000, param_2: 0.084000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "653", "CommutationAnalysis")

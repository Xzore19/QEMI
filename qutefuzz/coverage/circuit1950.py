...
subcirc0.rx(-0.331000, qreg_3[0])
subcirc0.rx(0.856000, qreg_0[1])
subcirc0.cz(qreg_2[0],qreg_3[0])
subcirc0.rx(0.722000, qreg_0[1])
...
subcirc2.z(qreg_2[0])
subcirc2.rx(0.966000, qreg_2[0])
subcirc2.cz(qreg_0[0],qreg_0[1])
subcirc2.rx(0.544000, qreg_2[0])
...
# Adding creg resources 
subcirc3.rx(-0.708000, qreg_0[1])
subcirc3.rx(-0.591000, qreg_0[0])
...
subcirc4.rx(-0.775000, qreg_1[2])
subcirc4.cx(qreg_1[2],qreg_1[0])
subcirc4.rx(-0.814000, qreg_1[1])
subcirc4.z(qreg_1[2])
subcirc4.rx(-0.732000, qreg_1[2])
...
main_circ.z(qreg_0[0])
main_circ.append(subcirc3,[qreg_0[0],qreg_3[0],qreg_0[1],qreg_0[2]])
main_circ.append(subcirc3,[qreg_3[0],qreg_0[2],qreg_0[0],qreg_0[1]])
main_circ.cx(qreg_3[0],qreg_0[0])
main_circ.append(subcirc4,[qreg_3[0],qreg_0[1],qreg_0[0],qreg_0[2]])
main_circ.rx(param_0, qreg_0[0])
main_circ.cx(qreg_3[0],qreg_0[2])
main_circ.cx(qreg_0[2],qreg_3[0])
bindings = {param_0: 0.652000, param_1: -0.355000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "1950")

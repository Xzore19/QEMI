...
subcirc0.u(0,0,0.136000, qreg_0[0])
subcirc0.x(qreg_0[0])
subcirc0.y(qreg_3[0])
subcirc0.x(qreg_0[1])
...
subcirc1.u(0,0,-0.544000, qreg_2[0])
...
# Adding creg resources 
subcirc2.u(0,0,0.603000, qreg_0[3])
subcirc2.cy(qreg_0[0],qreg_0[2])
subcirc2.u(0,0,0.203000, qreg_0[2])
...
main_circ.cy(qreg_0[0],qreg_0[1])
bindings = {param_0: -0.413000, param_1: -0.688000, param_3: -0.661000, }

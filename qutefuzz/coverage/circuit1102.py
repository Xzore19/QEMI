...
subcirc0.rx(-0.304000, qreg_0[1])
subcirc0.y(qreg_0[0])
subcirc0.cy(qreg_0[0],qreg_3[0])
subcirc0.x(qreg_0[1])
subcirc0.rx(-0.754000, qreg_2[0])
	...
	with main_circ.if_test((creg_0[1],0)):
		...
		with main_circ.switch(creg_0[1]) as case_1:
			...
			with case_1(1):
				...
				main_circ.append(subcirc2,[1,qreg_1[0],qreg_1[1],qreg_3[0],qreg_0[0],0])
with else_3:
	main_circ.barrier(0)
...
with main_circ.if_test((creg_0[0],0)) as else_3:
	...
	with main_circ.if_test((creg_0[1],0)) as else_2:
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			main_circ.append(subcirc2,[qreg_3[0],qreg_0[0],1,0,qreg_1[1],qreg_1[0]])
	with else_2:
		main_circ.append(subcirc2,[qreg_0[0],qreg_1[0],1,qreg_1[1],qreg_3[0],0])
with else_3:
	main_circ.append(subcirc1,[1,qreg_0[0],qreg_1[1],0])
...
with else_3:
	...
	with else_2:
		...
		main_circ.id(1)
	main_circ.id(qreg_3[0])
bindings = {param_3: -0.408000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1102", "CollectCliffords")

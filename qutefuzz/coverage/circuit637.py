...
subcirc0.x(qreg_3[0])
subcirc0.rx(0.375000, qreg_0[2])
subcirc0.x(qreg_3[0])
subcirc0.rx(-0.475000, qreg_0[2])
...
# Adding creg resources 
subcirc1.rx(-0.308000, qreg_2[0])
subcirc1.y(qreg_2[1])
subcirc1.x(qreg_0[0])
subcirc1.rx(0.302000, qreg_2[0])
...
bindings = {param_0: -0.732000, param_1: 1.000000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "637")

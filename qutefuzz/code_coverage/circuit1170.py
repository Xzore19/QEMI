...
# Adding creg resources 
subcirc2.rx(0.705000, qreg_0[0])
subcirc2.z(qreg_0[0])
subcirc2.rx(0.821000, qreg_1[1])
subcirc2.z(qreg_1[1])
...
with main_circ.switch(creg_0[1]) as case_1:
	...
	with case_1(1):
		...
		main_circ.append(subcirc2,[qreg_0[0],qreg_0[3],qreg_0[2],qreg_0[1]])
main_circ.measure(qreg_0[1], creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.z(qreg_0[2])
	main_circ.rx(-0.780000, qreg_0[3])
with else_1:
...
bindings = {param_2: -0.972000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1170", "Optimize1qGatesSimpleCommutation")

...
subcirc1.h(qreg_3[0])
subcirc1.ry(-0.229000, qreg_3[0])
subcirc1.ry(0.219000, qreg_0[1])
subcirc1.h(qreg_3[0])
...
main_circ.ry(0.385000, qreg_1[0])
...
with else_1:
	main_circ.barrier(qreg_1[0])
main_circ.ry(-0.083000, 3)
main_circ.x(1)
main_circ.measure(0, creg_1[0])
with main_circ.if_test((creg_1[0],0)) as else_1:
	main_circ.ry(param_1, qreg_1[0])
with else_1:
	main_circ.ry(-0.006000, qreg_1[0])
main_circ.measure(3, creg_1[0])
with main_circ.switch(creg_1[0]) as case_1:
	with case_1(0):
		main_circ.id(2)
	with case_1(1):
		...
		main_circ.x(3)
		main_circ.barrier(qreg_1[0])
bindings = {param_0: 0.110000, param_1: -0.650000, param_2: 0.211000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1380", "NormalizeRXAngle")

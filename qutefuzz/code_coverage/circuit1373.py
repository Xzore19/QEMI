...
subcirc1.u(-0.513000,-0.967000,-0.418000, qreg_0[0])
subcirc1.cy(qreg_3[0],qreg_0[1])
subcirc1.u(0.793000,-0.302000,0.662000, qreg_0[2])
		...
		with case_3(0):
			...
			with main_circ.if_test((creg_1[0],0)):
				...
				with main_circ.if_test((creg_1[0],0)) as else_1:
					main_circ.cz(qreg_0[2],qreg_3[0])
					main_circ.u(0.496000,param_1,0.591000, qreg_3[0])
					main_circ.cz(qreg_0[0],qreg_3[0])
					main_circ.cx(qreg_0[2],qreg_0[0])
					main_circ.u(param_0,param_0,0.355000, qreg_3[0])
				with else_1:
					main_circ.cx(qreg_0[0],qreg_0[1])
					main_circ.u(-0.354000,param_2,0.190000, qreg_0[0])
		...
		with main_circ.switch(creg_0[0]) as case_2:
			with case_2(0):
				...
				with main_circ.if_test((creg_0[0],0)) as else_1:
					...
					main_circ.cx(qreg_0[0],qreg_0[2])
					main_circ.u(param_2,0.329000,-0.903000, qreg_3[0])
				with else_1:
...
with else_4:
	...
	with else_3:
		main_circ.id(qreg_0[2])
	main_circ.id(qreg_0[1])
bindings = {param_0: 0.189000, param_1: -0.711000, param_2: -0.633000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1373")

...
subcirc0.u(0,0,-0.397000, qreg_0[3])
...
subcirc3.u(0,0,0.032000, qreg_0[2])
...
with main_circ.if_test((creg_0[0],0)):
	...
	main_circ.u(param_2,0,-0.628000, qreg_3[0])
	main_circ.cy(qreg_3[0],qreg_0[2])
...
main_circ.measure(qreg_3[0], creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.u(param_1,param_1,0.796000, qreg_0[0])
	main_circ.cz(qreg_0[1],qreg_3[0])
	main_circ.id(qreg_3[0])
with else_1:
	main_circ.id(qreg_0[1])
...
with main_circ.switch(creg_0[1]) as case_1:
	with case_1(0):
		...
		main_circ.barrier(qreg_0[0])
	with case_1(1):
		main_circ.u(param_3,0,-0.623000, qreg_0[0])
...
with main_circ.switch(creg_0[1]) as case_1:
	...
	with case_1(1):
		...
		main_circ.barrier(qreg_0[2])
main_circ.x(qreg_0[1])
main_circ.u(param_0,param_1,0.852000, qreg_0[2])
main_circ.measure(qreg_0[0], creg_0[1])
with main_circ.switch(creg_0[1]) as case_1:
	with case_1(0):
		main_circ.barrier(qreg_0[2])
...
main_circ.measure(qreg_0[1], creg_0[0])
with main_circ.if_test((creg_0[0],0)):
	main_circ.u(param_1,param_2,0.718000, qreg_0[2])
	main_circ.id(qreg_3[0])
main_circ.measure(qreg_0[1], creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.x(qreg_3[0])
...
main_circ.measure(qreg_3[0], creg_0[0])
with main_circ.if_test((creg_0[0],0)):
	main_circ.u(param_0,0,-0.200000, qreg_0[2])
	main_circ.cz(qreg_0[2],qreg_3[0])
	main_circ.id(qreg_0[0])
bindings = {param_0: 0.285000, param_1: 0.370000, param_2: 0.111000, param_3: 0.371000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "625", "HoareOptimizer")

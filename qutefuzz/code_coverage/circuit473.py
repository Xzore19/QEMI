...
main_circ.append(subcirc0,[qreg_0[3],qreg_0[0],0,qreg_0[1]])
main_circ.ry(0.008000, qreg_0[2])
main_circ.append(subcirc0,[qreg_0[0],0,qreg_0[2],qreg_0[1]])
main_circ.append(subcirc0,[qreg_0[1],qreg_0[2],qreg_0[3],0])
main_circ.append(subcirc1,[qreg_0[0],qreg_0[1],0,qreg_0[2],qreg_0[3]])
main_circ.ry(param_4, qreg_0[0])
main_circ.cz(qreg_0[2],0)
main_circ.ry(0.367000, 0)
main_circ.append(subcirc1,[qreg_0[2],qreg_0[3],qreg_0[1],qreg_0[0],0])
main_circ.append(subcirc1,[qreg_0[0],qreg_0[2],0,qreg_0[3],qreg_0[1]])
...
bindings = {param_4: 0.675000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "473")

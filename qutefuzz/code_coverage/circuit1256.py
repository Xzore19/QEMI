...
subcirc0.u(0.112000,0.416000,-0.330000, qreg_2[0])
subcirc0.cx(qreg_0[1],qreg_2[0])
subcirc0.cx(qreg_0[0],qreg_0[1])
subcirc0.u(-0.667000,0.327000,0.111000, qreg_0[1])
...
subcirc1.z(qreg_2[0])
subcirc1.u(0.043000,-0.809000,-0.056000, qreg_0[1])
subcirc1.z(qreg_2[0])
subcirc1.s(qreg_0[0])
...
subcirc2.u(0.073000,-0.113000,-0.508000, qreg_3[0])
subcirc2.z(qreg_3[0])
...
with main_circ.switch(creg_1[0]) as case_4:
	...
	with case_4(1):
		...
		with main_circ.if_test((creg_1[0],0)):
			...
			main_circ.append(subcirc2,[0,qreg_3[0],qreg_0[1],qreg_0[0]])
	...
	with main_circ.switch(creg_1[0]) as case_3:
				...
				with case_2(1):
					...
					with main_circ.switch(creg_0[0]) as case_1:
						with case_1(0):
							...
							main_circ.append(subcirc2,[qreg_0[0],qreg_3[0],0,qreg_2[0]])
						with case_1(1):
		...
		with case_3(1):
			...
			with main_circ.if_test((creg_0[0],0)) as else_2:
				main_circ.measure(qreg_0[1], creg_1[0])
				with main_circ.if_test((creg_1[0],0)) as else_1:
					main_circ.append(subcirc2,[qreg_3[0],qreg_2[0],qreg_0[0],qreg_0[1]])
				with else_1:
					main_circ.u(-0.896000,-0.020000,param_0, qreg_0[0])
			...
			with else_2:
				...
				main_circ.measure(qreg_0[0], creg_1[0])
				with main_circ.if_test((creg_1[0],0)) as else_1:
					main_circ.u(-0.391000,param_2,0.979000, qreg_3[0])
...
bindings = {param_0: 0.778000, param_2: -0.627000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1256")

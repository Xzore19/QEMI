...
subcirc0.u(0,0,0.000000, qreg_1[0])
subcirc0.u(0,0,0.504000, qreg_0[0])
subcirc0.cz(qreg_0[0],qreg_3[0])
...
subcirc1.u(0,0,-1.000000, qreg_0[0])
...
subcirc2.u(0,0,0.131000, qreg_2[1])
subcirc2.s(qreg_0[1])
subcirc2.u(0,0,-0.182000, qreg_0[1])
...
# Adding creg resources 
subcirc3.u(0,0,0.424000, qreg_0[1])
subcirc3.cz(qreg_0[0],qreg_0[1])
subcirc3.s(qreg_0[2])
subcirc3.s(qreg_0[1])
subcirc3.cx(qreg_0[1],qreg_0[0])
subcirc3.u(0,0,-0.795000, qreg_0[0])
...
# Adding creg resources 
subcirc4.u(0,0,-0.858000, qreg_3[0])
subcirc4.cx(qreg_3[0],qreg_2[0])
subcirc4.u(0,0,0.918000, qreg_2[0])
...
with main_circ.switch(creg_0[0]) as case_2:
	with case_2(0):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			...
			with case_1(1):
				main_circ.append(subcirc3,[3,2,qreg_0[0],1,0])
	with case_2(1):
		...
		with else_1:
			main_circ.append(subcirc3,[qreg_0[0],2,0,1,3])
main_circ.measure(0, creg_0[0])
...
with main_circ.if_test((creg_1[0],0)):
	...
	with main_circ.switch(creg_0[0]) as case_1:
		with case_1(0):
			main_circ.u(0,param_1,0.721000, 0)
			main_circ.cx(3,0)
			main_circ.id(qreg_0[0])
		with case_1(1):
			main_circ.id(qreg_0[0])
	main_circ.id(qreg_0[0])
bindings = {param_0: -0.858000, param_1: -0.798000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1343", "CommutationAnalysis")

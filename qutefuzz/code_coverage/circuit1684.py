...
with main_circ.switch(creg_1[0]) as case_1:
	...
	with case_1(1):
		...
		main_circ.ry(0.452000, qreg_0[0])
		main_circ.ry(0.228000, 1)
		main_circ.barrier(qreg_0[0])
main_circ.measure(qreg_0[0], creg_1[0])
with main_circ.if_test((creg_1[0],0)):
	main_circ.ry(-0.705000, 3)
	main_circ.cy(qreg_0[0],1)
	main_circ.cz(0,3)
main_circ.measure(1, creg_0[0])
with main_circ.switch(creg_0[0]) as case_1:
...
with main_circ.switch(creg_1[0]) as case_1:
	with case_1(0):
		main_circ.h(1)
		main_circ.cy(3,2)
		main_circ.ry(-0.375000, 3)
		main_circ.cz(qreg_0[0],2)
	with case_1(1):
		main_circ.ry(param_1, 3)
		main_circ.id(0)
bindings = {param_1: -0.737000, param_2: 0.244000, param_3: -0.426000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1684", "ConsolidateBlocks")

...
subcirc0.rz(0.462000, qreg_0[1])
subcirc0.s(qreg_0[3])
subcirc0.rz(0.634000, qreg_0[2])
subcirc0.rz(0.088000, qreg_0[2])
	...
	with case_3(0):
		...
		with main_circ.if_test((creg_0[1],0)) as else_2:
			...
			with main_circ.if_test((creg_0[1],0)):
				...
				main_circ.u(pi/2,param_0,-0.032000, qreg_0[2])
		with else_2:
			main_circ.measure(qreg_0[0], creg_0[1])
			with main_circ.switch(creg_0[1]) as case_1:
				with case_1(0):
					main_circ.cy(qreg_0[2],qreg_0[1])
					main_circ.append(subcirc0,[qreg_0[2],0,qreg_0[0],qreg_3[0]])
				with case_1(1):
	...
	with case_3(1):
		...
		with main_circ.if_test((creg_0[1],0)):
			...
			with main_circ.if_test((creg_0[1],0)) as else_1:
				main_circ.rz(0.314000, qreg_0[0])
				main_circ.rz(param_0, qreg_0[2])
				main_circ.u(param_0,param_0,param_0, qreg_3[0])
				main_circ.append(subcirc0,[1,0,qreg_0[2],qreg_3[0]])
			with else_1:
	...
	with main_circ.switch(creg_0[0]) as case_2:
		with case_2(0):
			...
			with else_1:
				...
				main_circ.append(subcirc0,[qreg_3[0],1,qreg_0[2],0])
		with case_2(1):
			...
			with else_1:
				main_circ.id(0)
			main_circ.id(qreg_0[2])
bindings = {param_0: 0.565000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "495")

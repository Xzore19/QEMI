...
main_circ.h(1)
main_circ.append(subcirc1,[2,qreg_0[0],1,0,qreg_1[0]])
main_circ.append(subcirc0,[0,qreg_0[0],3,2])
main_circ.append(subcirc3,[3,1,2,qreg_0[0],0,qreg_1[0]])
main_circ.h(2)
...
run_routing_simulation(main_circ, "498")

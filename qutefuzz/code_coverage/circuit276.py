...
main_circ.ry(0.335000, qreg_1[0])
main_circ.x(qreg_1[0])
...
main_circ.ry(0.158000, qreg_3[0])
...
main_circ.ry(-0.039000, qreg_1[1])
main_circ.ry(-0.661000, qreg_1[0])
main_circ.x(qreg_1[0])
main_circ.ry(param_1, qreg_1[1])
main_circ.x(qreg_1[1])
bindings = {param_0: -0.580000, param_1: 0.211000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "276")

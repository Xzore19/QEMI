...
subcirc0.ry(-0.743000, qreg_0[2])
subcirc0.rz(0.012000, qreg_0[2])
	...
	with case_4(0):
		...
		with else_3:
			...
			with main_circ.if_test((creg_0[1],0)) as else_2:
				main_circ.measure(qreg_0[0], creg_0[1])
				with main_circ.if_test((creg_0[1],0)) as else_1:
					main_circ.append(subcirc2,[2,qreg_0[0],0,1])
				with else_1:
	...
	with case_4(1):
		...
		with main_circ.switch(creg_0[0]) as case_3:
			...
			with case_3(1):
				main_circ.id(qreg_0[0])
		main_circ.id(1)
bindings = {param_0: 0.291000, param_1: -0.187000, param_2: 0.001000, param_3: -0.632000, param_4: -0.305000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1095")

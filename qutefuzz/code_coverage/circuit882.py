...
# Adding creg resources 
subcirc1.x(qreg_3[0])
subcirc1.rx(-0.910000, qreg_0[0])
subcirc1.x(qreg_0[1])
subcirc1.rx(0.245000, qreg_0[1])
...
main_circ.s(0)
main_circ.append(subcirc4,[3,0,1,qreg_0[0]])
...
main_circ.append(subcirc3,[3,qreg_0[0],1,0,2])
...
main_circ.x(1)
main_circ.z(1)
bindings = {param_1: -0.183000, param_4: 0.589000, }

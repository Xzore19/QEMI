...
with else_2:
	...
	with main_circ.switch(creg_0[1]) as case_1:
		...
		with case_1(1):
			main_circ.append(subcirc2,[qreg_2[0],qreg_3[0],qreg_0[0],qreg_1[0]])
...
with main_circ.if_test((creg_0[0],0)) as else_2:
	...
	with else_1:
		main_circ.append(subcirc1,[qreg_3[0],qreg_1[0],qreg_2[0],qreg_0[0]])
with else_2:
	main_circ.measure(qreg_3[0], creg_0[0])
	with main_circ.switch(creg_0[0]) as case_1:
		with case_1(0):
			main_circ.id(qreg_1[0])
		with case_1(1):
			main_circ.append(subcirc1,[qreg_0[0],qreg_1[0],qreg_2[0],qreg_3[0]])
main_circ.measure(qreg_3[0], creg_0[0])
with main_circ.if_test((creg_0[0],0)):
	main_circ.barrier(qreg_1[0])
main_circ.measure(qreg_3[0], creg_0[1])
with main_circ.if_test((creg_0[1],0)) as else_2:
	...
	main_circ.append(subcirc1,[qreg_2[0],qreg_3[0],qreg_0[0],qreg_1[0]])
with else_2:
	main_circ.barrier(qreg_2[0])
main_circ.measure(qreg_2[0], creg_0[1])
with main_circ.if_test((creg_0[1],0)):
	main_circ.append(subcirc1,[qreg_0[0],qreg_3[0],qreg_2[0],qreg_1[0]])
	main_circ.measure(qreg_3[0], creg_0[1])
...
run_pass_on_simulator(main_circ, "1456", "CollectCliffords")

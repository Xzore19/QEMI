...
main_circ.append(subcirc2,[qreg_0[2],qreg_0[1],0,qreg_3[0]])
main_circ.cx(0,qreg_0[0])
main_circ.cx(0,qreg_0[2])
main_circ.x(0)
main_circ.append(subcirc1,[qreg_0[0],qreg_3[0],qreg_0[2],0])
main_circ.append(subcirc2,[qreg_0[0],qreg_0[2],qreg_3[0],0])
main_circ.append(subcirc2,[qreg_0[1],qreg_0[2],qreg_3[0],qreg_0[0]])
main_circ.cx(qreg_0[1],qreg_3[0])
main_circ.append(subcirc2,[qreg_0[2],0,qreg_3[0],qreg_0[1]])
main_circ.x(qreg_0[2])
main_circ.x(qreg_0[0])
main_circ.append(subcirc2,[qreg_3[0],0,qreg_0[1],qreg_0[0]])
...
main_circ.y(qreg_0[0])
bindings = {param_0: 0.483000, param_1: -0.551000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "350")

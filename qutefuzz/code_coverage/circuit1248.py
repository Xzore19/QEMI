...
subcirc0.h(qreg_0[0])
subcirc0.u(0,0,0.097000, qreg_3[0])
...
subcirc1.z(qreg_0[2])
subcirc1.u(0,0,0.360000, qreg_0[2])
	...
	with main_circ.if_test((creg_0[0],0)) as else_2:
		...
		with main_circ.switch(creg_0[1]) as case_1:
			with case_1(0):
				...
				main_circ.u(0,param_6,-0.112000, qreg_3[0])
				main_circ.u(param_5,param_2,param_6, qreg_0[2])
	...
	with main_circ.if_test((creg_0[0],0)) as else_2:
		...
		with main_circ.switch(creg_0[0]) as case_1:
			with case_1(0):
				...
				main_circ.h(qreg_0[2])
				main_circ.u(param_6,0,param_5, qreg_3[0])
...
with main_circ.switch(creg_0[0]) as case_3:
		...
		with main_circ.switch(creg_0[1]) as case_2:
			with case_2(0):
				...
				with main_circ.if_test((creg_0[0],0)) as else_1:
					...
					main_circ.u(param_3,0,param_2, qreg_3[0])
					main_circ.id(qreg_0[0])
				with else_1:
					main_circ.h(qreg_3[0])
				...
				with main_circ.if_test((creg_0[0],0)):
					...
					main_circ.u(0,param_6,0.460000, qreg_0[2])
					main_circ.cx(qreg_0[0],qreg_0[2])
					main_circ.cx(qreg_3[0],qreg_0[1])
			with case_2(1):
				main_circ.measure(qreg_0[1], creg_0[0])
				with main_circ.if_test((creg_0[0],0)):
					main_circ.u(0,0,-0.634000, qreg_3[0])
					main_circ.cx(qreg_0[0],qreg_0[2])
					main_circ.id(qreg_0[1])
				main_circ.measure(qreg_3[0], creg_0[1])
				with main_circ.if_test((creg_0[1],0)):
	...
	with case_3(1):
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			main_circ.measure(qreg_0[2], creg_0[0])
			with main_circ.if_test((creg_0[0],0)):
				main_circ.u(param_3,0,param_4, qreg_0[2])
			main_circ.measure(qreg_3[0], creg_0[0])
			with main_circ.if_test((creg_0[0],0)) as else_1:
				main_circ.u(param_2,param_1,0.726000, qreg_0[0])
				main_circ.u(0,param_5,param_4, qreg_0[0])
				main_circ.z(qreg_3[0])
				main_circ.cx(qreg_0[0],qreg_0[1])
			with else_1:
				main_circ.u(0,param_5,-0.630000, qreg_0[1])
				main_circ.barrier(qreg_0[0])
main_circ.z(qreg_3[0])
main_circ.measure(qreg_0[1], creg_0[0])
	...
	with else_2:
		...
		with main_circ.switch(creg_0[0]) as case_1:
			with case_1(0):
				...
				main_circ.id(qreg_0[2])
			with case_1(1):
				main_circ.u(0,0,0.489000, qreg_0[0])
				main_circ.barrier(qreg_3[0])
		main_circ.measure(qreg_3[0], creg_0[1])
		with main_circ.if_test((creg_0[1],0)):
			main_circ.barrier(qreg_0[1])
...
with main_circ.if_test((creg_0[0],0)) as else_3:
	...
	with main_circ.if_test((creg_0[1],0)) as else_2:
		...
		with main_circ.if_test((creg_0[0],0)):
			main_circ.barrier(qreg_0[1])
		main_circ.u(0,0,0.561000, qreg_0[2])
		main_circ.measure(qreg_0[0], creg_0[1])
		with main_circ.if_test((creg_0[1],0)) as else_1:
			main_circ.cx(qreg_0[0],qreg_0[1])
			main_circ.barrier(qreg_0[2])
...
with else_3:
	main_circ.barrier(qreg_3[0])
bindings = {param_0: 0.615000, param_1: -0.001000, param_2: 0.595000, param_3: -0.574000, param_4: 0.667000, param_5: -0.613000, param_6: -0.969000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1248")

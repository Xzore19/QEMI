...
subcirc1.z(qreg_2[1])
subcirc1.h(qreg_2[0])
subcirc1.u(pi/2,0.018000,-0.583000, qreg_2[1])
...
main_circ.h(0)
main_circ.u(pi/2,-0.867000,param_0, qreg_0[1])
main_circ.h(0)
main_circ.u(pi/2,param_1,param_3, qreg_3[0])
main_circ.h(0)
main_circ.append(subcirc0,[qreg_0[2],0,1,qreg_0[0]])
main_circ.z(1)
main_circ.h(1)
main_circ.append(subcirc0,[qreg_0[1],1,qreg_3[0],qreg_0[0]])
main_circ.z(qreg_0[2])
main_circ.z(qreg_0[1])
main_circ.append(subcirc0,[qreg_0[1],0,qreg_3[0],qreg_0[2]])
main_circ.u(param_4,param_3,param_1, qreg_0[1])
main_circ.append(subcirc0,[qreg_0[2],qreg_0[0],1,qreg_3[0]])
...
main_circ.z(0)
main_circ.u(pi/2,0.634000,-0.458000, 0)
main_circ.cy(1,qreg_3[0])
main_circ.z(qreg_0[1])
main_circ.z(0)
bindings = {param_0: -0.563000, param_1: -0.092000, param_3: -0.744000, param_4: -0.301000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "1492")

...
main_circ.rz(0.077000, qreg_0[2])
main_circ.rz(0.256000, qreg_3[0])
main_circ.rz(-0.565000, qreg_0[1])
main_circ.rx(-0.884000, qreg_3[0])
main_circ.rx(-0.177000, qreg_3[0])
main_circ.rx(param_1, qreg_0[2])
main_circ.cz(qreg_0[0],qreg_0[1])
main_circ.y(qreg_0[2])
main_circ.rx(-0.580000, qreg_0[1])
main_circ.rx(param_1, qreg_0[0])
main_circ.cz(qreg_3[0],qreg_0[0])
main_circ.rz(param_1, qreg_0[1])
main_circ.rx(param_1, qreg_0[1])
main_circ.rx(0.236000, qreg_0[2])
main_circ.rx(param_0, qreg_3[0])
main_circ.y(qreg_0[2])
main_circ.rz(param_2, qreg_0[1])
main_circ.y(qreg_0[2])
main_circ.rx(-0.288000, qreg_3[0])
main_circ.rx(0.372000, qreg_0[1])
main_circ.rx(0.941000, qreg_0[1])
main_circ.rz(-0.328000, qreg_0[0])
main_circ.rx(-0.614000, qreg_3[0])
main_circ.rx(-0.368000, qreg_0[2])
...
main_circ.rx(0.341000, qreg_0[1])
main_circ.rx(param_1, qreg_0[1])
...
main_circ.rx(0.774000, qreg_3[0])
main_circ.rx(-0.226000, qreg_0[2])
main_circ.rx(-0.586000, qreg_0[0])
bindings = {param_0: -0.387000, param_1: -0.850000, param_2: 0.061000, }

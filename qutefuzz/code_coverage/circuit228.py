...
subcirc0.u(0,0,0.219000, qreg_1[0])
...
# Adding creg resources 
subcirc2.u(0,0,-0.776000, qreg_2[1])
subcirc2.cz(qreg_2[1],qreg_0[0])
subcirc2.u(0,0,0.599000, qreg_0[0])
subcirc2.u(0,0,-0.935000, qreg_1[0])
subcirc2.u(0,0,0.856000, qreg_2[0])
subcirc2.z(qreg_1[0])
...
subcirc4.s(qreg_0[2])
subcirc4.u(0,0,-0.796000, qreg_3[0])
subcirc4.cz(qreg_0[0],qreg_0[2])
subcirc4.u(0,0,0.924000, qreg_0[0])
subcirc4.z(qreg_0[1])
...
main_circ.z(3)
main_circ.append(subcirc4,[0,qreg_0[0],2,3,1])
main_circ.z(0)
main_circ.append(subcirc0,[2,1,0,3])
main_circ.append(subcirc4,[1,3,qreg_0[0],2,0])
main_circ.append(subcirc0,[qreg_0[0],1,3,0])
main_circ.append(subcirc4,[1,0,3,2,qreg_0[0]])
...
run_routing_simulation(main_circ, "228")

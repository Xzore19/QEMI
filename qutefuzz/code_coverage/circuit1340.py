...
with main_circ.switch(creg_0[0]) as case_4:
	with case_4(0):
		...
		with main_circ.switch(creg_0[0]) as case_3:
			with case_3(0):
				...
				with main_circ.if_test((creg_0[0],0)) as else_2:
					...
					with main_circ.if_test((creg_0[0],0)):
						main_circ.ry(-0.494000, 1)
						main_circ.barrier(0)
					main_circ.measure(0, creg_0[1])
					with main_circ.switch(creg_0[1]) as case_1:
						with case_1(0):
							main_circ.ry(param_2, 0)
							main_circ.append(subcirc2,[qreg_0[1],qreg_2[0],0,1,qreg_0[0],qreg_2[1]])
						with case_1(1):
							main_circ.append(subcirc2,[qreg_2[0],qreg_2[1],0,1,qreg_0[1],qreg_0[0]])
				with else_2:
			...
			with case_3(1):
				main_circ.append(subcirc2,[1,qreg_2[1],qreg_0[1],qreg_2[0],0,qreg_0[0]])
	with case_4(1):
		main_circ.measure(qreg_0[1], creg_0[0])
		with main_circ.if_test((creg_0[0],0)):
			main_circ.measure(qreg_0[0], creg_0[0])
			with main_circ.if_test((creg_0[0],0)) as else_2:
				main_circ.append(subcirc2,[qreg_2[1],qreg_0[0],qreg_0[1],qreg_2[0],1,0])
			with else_2:
				main_circ.measure(qreg_0[0], creg_0[0])
				with main_circ.switch(creg_0[0]) as case_1:
					...
					with case_1(1):
						...
						main_circ.append(subcirc2,[qreg_2[0],1,qreg_0[1],qreg_0[0],0,qreg_2[1]])
main_circ.append(subcirc0,[0,qreg_2[0],qreg_0[1],qreg_0[0]])
	...
	with main_circ.switch(creg_0[1]) as case_3:
		with case_3(0):
			...
			with main_circ.if_test((creg_0[1],0)) as else_2:
				main_circ.measure(qreg_2[1], creg_0[1])
				with main_circ.if_test((creg_0[1],0)):
					main_circ.append(subcirc0,[qreg_0[0],qreg_0[1],qreg_2[1],1])
				main_circ.cy(0,1)
			with else_2:
				main_circ.measure(qreg_0[0], creg_0[1])
				with main_circ.if_test((creg_0[1],0)):
					main_circ.append(subcirc2,[qreg_0[0],qreg_2[1],0,1,qreg_2[0],qreg_0[1]])
		with case_3(1):
			main_circ.measure(qreg_0[1], creg_0[0])
			with main_circ.if_test((creg_0[0],0)) as else_2:
				main_circ.measure(0, creg_0[1])
...
with main_circ.switch(creg_0[1]) as case_4:
	...
	with case_4(1):
		main_circ.barrier(qreg_2[1])
bindings = {param_2: 0.546000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1340", "CXCancellation")

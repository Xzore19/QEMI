...
subcirc1.rz(-0.303000, qreg_3[0])
subcirc1.rz(0.009000, qreg_0[1])
subcirc1.rz(0.947000, qreg_0[0])
...
main_circ.append(subcirc0,[qreg_2[0],qreg_0[0],qreg_0[1],qreg_3[0],0])
...
main_circ.h(qreg_0[0])
main_circ.append(subcirc0,[qreg_3[0],0,qreg_2[0],qreg_0[0],qreg_0[1]])
main_circ.rz(param_1, qreg_3[0])
main_circ.rz(-0.139000, qreg_3[0])
main_circ.cy(qreg_3[0],qreg_0[1])
main_circ.cy(0,qreg_3[0])
main_circ.append(subcirc3,[qreg_3[0],qreg_0[1],0,qreg_2[0]])
main_circ.cz(qreg_0[1],qreg_3[0])
main_circ.rz(0.092000, qreg_0[0])

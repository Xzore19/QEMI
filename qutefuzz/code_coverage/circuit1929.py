...
subcirc0.u(pi/2,-0.813000,0.788000, qreg_1[0])
subcirc0.x(qreg_0[0])
subcirc0.cx(qreg_3[0],qreg_2[0])
subcirc0.u(pi/2,0.165000,0.653000, qreg_2[0])
...
main_circ.u(param_2,param_1,0.816000, qreg_0[0])
...
main_circ.x(qreg_2[1])
main_circ.cx(qreg_2[0],qreg_2[1])
main_circ.u(pi/2,0.045000,param_2, qreg_2[1])
bindings = {param_1: 0.350000, param_2: 0.532000, }

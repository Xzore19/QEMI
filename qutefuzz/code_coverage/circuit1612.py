...
# Adding creg resources 
subcirc1.rz(0.267000, qreg_2[1])
subcirc1.cy(qreg_2[0],qreg_1[0])
...
main_circ.append(subcirc0,[0,qreg_0[1],qreg_0[2],qreg_0[3]])
main_circ.cx(0,qreg_0[2])
main_circ.x(qreg_0[3])
main_circ.x(qreg_0[1])
main_circ.cx(qreg_0[2],1)
main_circ.append(subcirc2,[qreg_0[0],1,qreg_0[1],0])
main_circ.append(subcirc0,[qreg_0[1],1,qreg_0[0],qreg_0[2]])
main_circ.rz(0.514000, 1)
main_circ.append(subcirc2,[qreg_0[3],0,qreg_0[1],qreg_0[0]])
main_circ.cy(1,qreg_0[1])
main_circ.rz(param_0, qreg_0[1])
main_circ.rz(0.771000, 1)
...
main_circ.append(subcirc0,[qreg_0[3],0,qreg_0[0],qreg_0[1]])
main_circ.cy(qreg_0[1],qreg_0[2])
main_circ.append(subcirc0,[qreg_0[1],qreg_0[3],0,qreg_0[2]])
main_circ.append(subcirc2,[0,qreg_0[0],qreg_0[3],1])
...
main_circ.rz(0.693000, qreg_0[1])
main_circ.rz(param_3, 0)
main_circ.rz(param_3, 0)
bindings = {param_0: -0.503000, param_3: -0.535000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "1612")

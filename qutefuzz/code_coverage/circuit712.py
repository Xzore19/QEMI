...
main_circ.append(subcirc2,[3,1,qreg_0[0],0,qreg_1[0],2])
main_circ.h(2)
main_circ.measure(2, creg_0[0])
with main_circ.if_test((creg_0[0],0)):
	main_circ.append(subcirc2,[0,1,qreg_0[0],3,2,qreg_1[0]])
...
with main_circ.switch(creg_0[1]) as case_1:
	...
	with case_1(1):
		...
		main_circ.append(subcirc0,[qreg_0[0],2,qreg_1[0],0])
...
main_circ.append(subcirc2,[qreg_0[0],qreg_1[0],3,2,0,1])
...
run_on_simulator(main_circ, "712")

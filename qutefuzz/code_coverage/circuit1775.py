...
with main_circ.switch(creg_1[0]) as case_1:
	with case_1(0):
		...
		main_circ.append(subcirc2,[qreg_0[0],qreg_1[0],1,2])
	with case_1(1):
		main_circ.append(subcirc0,[2,0,1,qreg_1[0]])
main_circ.measure(1, creg_0[0])
with main_circ.if_test((creg_0[0],0)) as else_1:
	main_circ.append(subcirc2,[qreg_1[0],1,3,0])
with else_1:
	main_circ.y(qreg_0[0])
	main_circ.z(qreg_1[0])
	main_circ.append(subcirc0,[qreg_1[0],1,2,3])
...
with main_circ.if_test((creg_0[0],0)):
	main_circ.append(subcirc0,[0,2,qreg_1[0],qreg_0[0]])
...
run_pass_on_simulator(main_circ, "1775", "Collect1qRuns")

...
subcirc1.rx(0.084000, qreg_0[3])
subcirc1.rx(-0.625000, qreg_0[1])
subcirc1.h(qreg_0[1])
subcirc1.h(qreg_0[2])
subcirc1.rx(-0.786000, qreg_0[3])
...
subcirc3.z(qreg_0[0])
subcirc3.y(qreg_1[1])
subcirc3.rx(0.867000, qreg_1[0])
subcirc3.h(qreg_1[0])
subcirc3.rx(-0.470000, qreg_1[0])
	...
	with else_3:
		...
		with main_circ.switch(creg_0[1]) as case_2:
			...
			with case_2(1):
				...
				with main_circ.switch(creg_0[1]) as case_1:
					with case_1(0):
						main_circ.append(subcirc3,[qreg_3[0],qreg_1[1],qreg_1[0],qreg_0[0]])
					with case_1(1):
						main_circ.y(qreg_1[0])
						main_circ.barrier(qreg_0[0])
with else_4:
...
with else_4:
	...
	with else_3:
		...
		main_circ.id(qreg_3[0])
	main_circ.id(qreg_1[0])
bindings = {param_0: -0.652000, param_1: 0.988000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1403")

...
# Adding creg resources 
subcirc1.u(0,0,0.848000, qreg_0[1])
subcirc1.u(0,0,-0.107000, qreg_2[1])
...
subcirc2.x(qreg_0[0])
subcirc2.u(0,0,0.441000, qreg_0[0])
subcirc2.ry(0.168000, qreg_0[0])
...
# Adding creg resources 
subcirc3.ry(-0.390000, qreg_0[0])
subcirc3.x(qreg_2[0])
subcirc3.cx(qreg_2[1],qreg_2[0])
subcirc3.u(0,0,-0.198000, qreg_2[1])
...
main_circ.cx(2,0)
main_circ.ry(-0.978000, 0)
main_circ.append(subcirc1,[qreg_0[0],2,1,3])
main_circ.x(0)
...
bindings = {param_1: 0.068000, param_2: 0.902000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "85")

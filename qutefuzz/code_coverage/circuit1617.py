...
# Adding creg resources 
subcirc1.s(qreg_0[0])
subcirc1.rz(0.653000, qreg_0[3])
subcirc1.rz(0.094000, qreg_0[0])
subcirc1.rz(0.760000, qreg_0[2])
...
with main_circ.if_test((creg_0[1],0)):
	...
	with main_circ.if_test((creg_0[1],0)):
		...
		with else_1:
			...
			main_circ.append(subcirc0,[qreg_2[1],qreg_0[0],qreg_2[0],qreg_0[1]])
...
with main_circ.if_test((creg_0[1],0)) as else_3:
	...
	with main_circ.if_test((creg_0[1],0)) as else_2:
		...
		with else_1:
			main_circ.rz(-0.318000, qreg_2[0])
...
bindings = {param_1: -0.509000, param_2: -0.264000, param_3: -0.493000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1617")

...
with else_3:
	...
	with main_circ.if_test((creg_0[0],0)):
		...
		with else_1:
			main_circ.ry(0.853000, qreg_0[2])
		main_circ.measure(qreg_0[0], creg_0[1])
		with main_circ.if_test((creg_0[1],0)):
			main_circ.barrier(qreg_0[0])
		main_circ.x(qreg_0[0])
		...
		with main_circ.if_test((creg_0[0],0)) as else_1:
			...
			main_circ.ry(0.792000, qreg_0[3])
		with else_1:
			main_circ.ry(0.859000, qreg_0[0])
main_circ.measure(qreg_0[1], creg_0[1])
with main_circ.if_test((creg_0[1],0)) as else_3:
	...
	with else_2:
		...
		main_circ.measure(qreg_0[2], creg_0[0])
		with main_circ.if_test((creg_0[0],0)) as else_1:
			main_circ.ry(-0.591000, qreg_0[3])
			main_circ.x(qreg_0[3])
...
with else_3:
	...
	with main_circ.switch(creg_0[1]) as case_2:
		with case_2(0):
			...
			with main_circ.if_test((creg_0[0],0)):
				main_circ.s(qreg_0[3])
				main_circ.ry(-0.447000, qreg_0[1])
			main_circ.barrier(qreg_0[0])
		with case_2(1):
			main_circ.measure(qreg_0[2], creg_0[0])
			...
			with main_circ.if_test((creg_0[1],0)):
				main_circ.barrier(qreg_0[1])
			main_circ.ry(0.338000, qreg_0[3])
			main_circ.ry(0.726000, qreg_0[1])
			main_circ.measure(qreg_0[1], creg_0[1])
			with main_circ.if_test((creg_0[1],0)):
				main_circ.cx(qreg_0[0],qreg_0[2])
				main_circ.ry(0.341000, qreg_0[3])
main_circ.measure(qreg_0[0], creg_0[0])
with main_circ.switch(creg_0[0]) as case_3:
	...
	with case_3(1):
		main_circ.id(qreg_0[3])
bindings = {param_0: 0.851000, param_1: 0.225000, param_2: 0.827000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "208", "RemoveFinalReset")

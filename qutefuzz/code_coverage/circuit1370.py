...
subcirc0.rz(-0.329000, qreg_0[2])
subcirc0.rz(0.583000, qreg_3[0])
subcirc0.cx(qreg_0[0],qreg_0[2])
subcirc0.rz(-0.526000, qreg_0[1])
...
main_circ.y(3)
main_circ.rz(-0.550000, 1)
main_circ.append(subcirc2,[2,qreg_0[0],3,0])
main_circ.rz(param_0, 3)
main_circ.u(pi/2,param_1,-0.147000, qreg_0[0])
main_circ.append(subcirc0,[qreg_0[0],3,2,1])
bindings = {param_0: 0.894000, param_1: 0.259000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "1370")

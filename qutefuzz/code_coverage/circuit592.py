...
with main_circ.if_test((creg_0[0],0)):
	...
	with main_circ.switch(creg_0[0]) as case_1:
		with case_1(0):
			main_circ.append(subcirc2,[qreg_0[3],qreg_0[1],0,qreg_0[0],qreg_0[2]])
		with case_1(1):
...
with main_circ.if_test((creg_0[1],0)):
	...
	with else_1:
		main_circ.ry(-0.210000, qreg_0[2])
		main_circ.append(subcirc2,[qreg_0[0],qreg_0[3],0,qreg_0[2],qreg_0[1]])
main_circ.measure(qreg_0[1], creg_0[1])
with main_circ.if_test((creg_0[1],0)):
	...
	main_circ.id(0)
bindings = {param_5: -0.480000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "592", "Collect1qRuns")

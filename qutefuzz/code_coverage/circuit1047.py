...
subcirc0.s(qreg_2[1])
subcirc0.u(0,0,0.124000, qreg_1[0])
...
subcirc1.s(qreg_0[0])
subcirc1.s(qreg_1[1])
subcirc1.u(0,0,0.164000, qreg_3[0])
...
with main_circ.switch(creg_1[0]) as case_2:
	...
	with case_2(1):
		...
		with main_circ.if_test((creg_1[0],0)):
			main_circ.u(param_1,param_0,0.934000, qreg_0[0])
...
with main_circ.switch(creg_1[0]) as case_2:
	with case_2(0):
		...
		with main_circ.if_test((creg_1[0],0)) as else_1:
			main_circ.u(0,0,0.737000, qreg_0[1])
			main_circ.cx(qreg_0[1],qreg_0[2])
	...
	with case_2(1):
		...
		with main_circ.if_test((creg_1[0],0)) as else_1:
			main_circ.y(qreg_0[1])
			main_circ.u(0,0,-0.250000, qreg_0[1])
			main_circ.y(qreg_0[0])
		with else_1:
		...
		with else_1:
			main_circ.barrier(qreg_0[1])
		main_circ.barrier(qreg_0[3])
bindings = {param_0: 0.936000, param_1: 0.702000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1047")

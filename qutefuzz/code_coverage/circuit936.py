...
subcirc1.h(qreg_0[1])
subcirc1.h(qreg_0[3])
subcirc1.u(0,0,-0.884000, qreg_0[2])
subcirc1.x(qreg_0[2])
subcirc1.x(qreg_0[2])
			...
			with case_3(0):
				...
				with main_circ.switch(creg_0[0]) as case_2:
					...
					with case_2(1):
						...
						with main_circ.if_test((creg_0[0],0)):
							main_circ.h(2)
							main_circ.u(param_2,param_0,-0.261000, 1)
							main_circ.x(1)
						main_circ.measure(2, creg_1[0])
						with main_circ.if_test((creg_1[0],0)) as else_1:
							main_circ.z(1)
			...
			with case_3(1):
				...
				with else_2:
					...
					with else_1:
						main_circ.barrier(1)
					main_circ.barrier(2)
bindings = {param_0: 0.493000, param_1: 0.350000, param_2: -0.042000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "936")

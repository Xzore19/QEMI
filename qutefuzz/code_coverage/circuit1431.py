...
main_circ.h(2)
main_circ.append(subcirc1,[1,3,qreg_1[0],qreg_0[0],0])
main_circ.x(0)
main_circ.h(qreg_1[0])
main_circ.h(3)
main_circ.h(2)
main_circ.append(subcirc1,[3,qreg_0[0],qreg_1[0],2,1])
main_circ.h(3)
...
main_circ.cx(2,0)
main_circ.append(subcirc2,[qreg_1[0],0,qreg_0[0],2])
main_circ.h(qreg_1[0])
...
run_routing_simulation(main_circ, "1431")

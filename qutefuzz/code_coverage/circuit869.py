...
with else_2:
	...
	with main_circ.switch(creg_0[1]) as case_1:
		with case_1(0):
			main_circ.ry(-0.014000, qreg_0[1])
			main_circ.cy(1,3)
			main_circ.cy(2,0)
...
with main_circ.if_test((creg_0[0],0)):
	...
	with main_circ.switch(creg_0[0]) as case_1:
		...
		with case_1(1):
			...
			main_circ.ry(0.571000, qreg_0[0])
...
with main_circ.if_test((creg_0[1],0)) as else_2:
	...
	with main_circ.switch(creg_0[1]) as case_1:
		with case_1(0):
			main_circ.cx(2,3)
			main_circ.ry(-0.565000, 3)
			main_circ.cx(0,3)
			main_circ.cy(qreg_0[1],2)
		with case_1(1):
			main_circ.cy(qreg_0[0],3)
			main_circ.cx(1,0)
			main_circ.ry(-0.222000, 2)
			main_circ.cy(qreg_0[0],0)
with else_2:
	main_circ.ry(0.077000, 0)
...
bindings = {param_1: 0.471000, param_2: 0.188000, param_3: -0.819000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "869", "CollectCliffords")

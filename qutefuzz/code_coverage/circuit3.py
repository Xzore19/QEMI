...
main_circ.rx(0.825000, qreg_0[0])
main_circ.x(qreg_1[2])
main_circ.append(subcirc2,[qreg_1[1],qreg_1[0],qreg_0[0],qreg_1[2]])
...
main_circ.rx(-0.668000, qreg_1[1])
main_circ.x(qreg_1[0])
bindings = {param_0: -0.096000, param_2: 0.397000, }

...
with else_2:
	...
	with main_circ.if_test((creg_1[0],0)) as else_1:
		main_circ.append(subcirc4,[0,qreg_0[0],3,2,1])
	with else_1:
		main_circ.cx(3,qreg_0[0])
		main_circ.h(2)
		main_circ.append(subcirc4,[3,0,qreg_0[0],1,2])
	...
	with case_2(0):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			with case_1(0):
				...
				main_circ.append(subcirc4,[3,qreg_0[0],0,2,1])
			with case_1(1):
				main_circ.cx(3,0)
				main_circ.cx(2,0)
				main_circ.id(3)
...
run_on_simulator(main_circ, "955")

...
subcirc1.s(qreg_0[2])
subcirc1.u(0,0,0.025000, qreg_0[2])
...
# Adding creg resources 
subcirc2.s(qreg_0[2])
subcirc2.u(0,0,-0.645000, qreg_0[2])
subcirc2.cy(qreg_3[0],qreg_0[0])
subcirc2.u(0,0,-0.782000, qreg_3[0])
subcirc2.s(qreg_3[0])
...
main_circ.append(subcirc2,[0,qreg_0[2],qreg_0[1],qreg_0[3]])
main_circ.append(subcirc2,[qreg_0[0],qreg_0[1],0,qreg_0[2]])
...
main_circ.u(param_0,0,-0.539000, qreg_0[3])
main_circ.s(qreg_0[0])
main_circ.u(0,param_5,param_4, 0)
main_circ.u(param_2,0,param_4, qreg_0[2])
main_circ.cy(qreg_0[1],qreg_0[0])
bindings = {param_0: 0.650000, param_2: 0.600000, param_4: -0.031000, param_5: 0.790000, }

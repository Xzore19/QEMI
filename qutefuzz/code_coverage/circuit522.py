...
subcirc1.ry(0.515000, qreg_0[0])
subcirc1.x(qreg_0[2])
subcirc1.ry(0.661000, qreg_3[0])
...
# Adding creg resources 
subcirc2.ry(-0.472000, qreg_0[2])
subcirc2.h(qreg_0[1])
subcirc2.cy(qreg_0[1],qreg_3[0])
subcirc2.ry(-0.847000, qreg_0[1])
...
main_circ.x(1)
main_circ.append(subcirc0,[1,qreg_0[0],3,0,2])
main_circ.h(1)
main_circ.h(qreg_0[0])
main_circ.append(subcirc2,[2,qreg_0[0],1,0])
...
main_circ.h(1)
main_circ.cy(3,0)
bindings = {param_5: -0.221000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "522")

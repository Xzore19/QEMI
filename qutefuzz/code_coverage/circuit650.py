...
subcirc0.rx(-0.290000, qreg_3[0])
subcirc0.rx(0.267000, qreg_3[0])
subcirc0.s(qreg_1[1])
...
# Adding creg resources 
subcirc1.rx(-0.772000, qreg_0[0])
subcirc1.rx(-0.477000, qreg_1[0])
subcirc1.rx(0.094000, qreg_1[1])
subcirc1.rx(0.470000, qreg_3[0])
...
bindings = {param_0: 0.579000, param_1: -0.285000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "650")

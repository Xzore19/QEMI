	...
	with main_circ.if_test((creg_0[0],0)):
		...
		with main_circ.if_test((creg_1[0],0)):
			...
			with main_circ.switch(creg_1[0]) as case_1:
				...
				with case_1(1):
					main_circ.cx(0,3)
					main_circ.append(subcirc3,[3,2,0,1,qreg_0[0],qreg_1[0]])
with else_4:
	...
	with main_circ.if_test((creg_0[0],0)):
		...
		with main_circ.if_test((creg_1[0],0)):
			...
			with main_circ.if_test((creg_0[0],0)) as else_1:
				main_circ.append(subcirc0,[qreg_1[0],2,3,qreg_0[0]])
			with else_1:
...
with main_circ.if_test((creg_0[0],0)) as else_4:
	...
	with main_circ.if_test((creg_1[0],0)) as else_3:
		...
		with main_circ.switch(creg_0[0]) as case_2:
			with case_2(0):
				main_circ.append(subcirc2,[1,2,qreg_0[0],0,3,qreg_1[0]])
			with case_2(1):
				main_circ.measure(qreg_1[0], creg_0[0])
				with main_circ.if_test((creg_0[0],0)) as else_1:
...
run_on_simulator(main_circ, "826")

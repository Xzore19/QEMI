		...
		with main_circ.if_test((creg_1[0],0)):
			...
			with main_circ.if_test((creg_1[0],0)) as else_2:
				...
				with main_circ.switch(creg_1[0]) as case_1:
					with case_1(0):
						...
						main_circ.rz(0.009000, qreg_0[0])
						main_circ.rx(param_0, qreg_3[0])
					with case_1(1):
						main_circ.x(1)
						main_circ.rx(0.081000, qreg_0[0])
			...
			with else_2:
				...
				with main_circ.switch(creg_0[0]) as case_1:
					with case_1(0):
						main_circ.y(qreg_1[0])
						main_circ.rz(-0.092000, qreg_1[1])
						main_circ.x(0)
						main_circ.rz(-0.623000, qreg_3[0])
					with case_1(1):
						main_circ.x(qreg_3[0])
						main_circ.rx(-0.760000, 0)
			...
			with main_circ.switch(creg_0[0]) as case_2:
				...
				with case_2(1):
					...
					with main_circ.switch(creg_0[0]) as case_1:
						...
						with case_1(1):
							main_circ.x(qreg_3[0])
							main_circ.rx(-0.633000, 0)
							main_circ.rz(param_0, 1)
							main_circ.rx(0.620000, 1)
main_circ.x(qreg_0[0])
main_circ.measure(qreg_0[0], creg_1[0])
with main_circ.if_test((creg_1[0],0)):
		...
		with main_circ.switch(creg_0[0]) as case_2:
			with case_2(0):
				...
				with main_circ.if_test((creg_0[0],0)):
					...
					main_circ.x(qreg_3[0])
					main_circ.rx(0.413000, qreg_1[0])
			with case_2(1):
				main_circ.measure(qreg_0[0], creg_0[0])
				with main_circ.if_test((creg_0[0],0)):
...
with main_circ.if_test((creg_1[0],0)):
	...
	with main_circ.if_test((creg_0[0],0)):
		...
		with main_circ.if_test((creg_1[0],0)):
			...
			with main_circ.if_test((creg_0[0],0)) as else_1:
				main_circ.rz(-0.046000, qreg_1[1])
			with else_1:
				main_circ.id(0)
			main_circ.barrier(1)
	main_circ.measure(qreg_0[0], creg_1[0])
	...
	with main_circ.switch(creg_1[0]) as case_3:
		...
		with case_3(1):
			...
			main_circ.barrier(qreg_3[0])
	main_circ.barrier(1)
bindings = {param_0: -0.483000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1344")

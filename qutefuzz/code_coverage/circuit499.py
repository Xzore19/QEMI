...
subcirc0.rx(-0.981000, qreg_0[2])
subcirc0.cx(qreg_0[1],qreg_0[2])
subcirc0.rz(0.313000, qreg_0[2])
subcirc0.rz(-0.132000, qreg_0[2])
...
# Adding creg resources 
subcirc1.rz(0.367000, qreg_1[2])
subcirc1.rz(-0.754000, qreg_1[1])
subcirc1.ry(-0.585000, qreg_1[0])
...
with else_4:
	...
	with main_circ.switch(creg_0[0]) as case_3:
		with case_3(0):
			main_circ.rz(0.814000, qreg_3[0])
			main_circ.barrier(0)
		with case_3(1):
			...
			with main_circ.if_test((creg_0[0],0)):
				...
				with main_circ.switch(creg_0[0]) as case_1:
					with case_1(0):
						...
						main_circ.ry(0.199000, qreg_0[0])
						main_circ.barrier(qreg_0[0])
					with case_1(1):
						main_circ.rz(0.645000, qreg_0[1])
						main_circ.rx(-0.534000, qreg_0[0])
...
with main_circ.if_test((creg_0[1],0)) as else_4:
	...
	with main_circ.if_test((creg_0[1],0)):
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			...
			with main_circ.switch(creg_0[1]) as case_1:
				with case_1(0):
					main_circ.rx(-0.322000, qreg_0[0])
					main_circ.cx(qreg_0[1],qreg_0[2])
					main_circ.cx(qreg_0[2],qreg_0[0])
					main_circ.ry(-0.413000, qreg_3[0])
				with case_1(1):
					main_circ.id(qreg_0[1])
		with else_2:
			main_circ.measure(qreg_3[0], creg_0[0])
			with main_circ.if_test((creg_0[0],0)) as else_1:
				main_circ.ry(0.056000, qreg_0[0])
				main_circ.barrier(qreg_0[2])
			with else_1:
				main_circ.cx(qreg_0[2],0)
				main_circ.rx(-0.927000, qreg_0[0])
				main_circ.rx(0.807000, qreg_3[0])
		...
		with case_3(1):
			...
			with main_circ.switch(creg_0[0]) as case_2:
				with case_2(0):
					...
					with main_circ.switch(creg_0[0]) as case_1:
						with case_1(0):
							main_circ.ry(-0.071000, qreg_0[2])
							main_circ.id(qreg_0[2])
						with case_1(1):
							main_circ.rx(-0.363000, qreg_0[2])
				...
				with case_2(1):
					...
					with main_circ.switch(creg_0[0]) as case_1:
						with case_1(0):
							...
							main_circ.barrier(qreg_0[2])
						with case_1(1):
							main_circ.ry(-0.592000, qreg_0[1])
							main_circ.rz(0.884000, qreg_0[2])
							main_circ.rx(param_1, qreg_0[0])
							main_circ.ry(-0.220000, qreg_0[1])
...
with main_circ.switch(creg_0[0]) as case_4:
	with case_4(0):
		...
		with main_circ.if_test((creg_0[1],0)) as else_3:
			main_circ.ry(-0.299000, qreg_3[0])
			main_circ.measure(qreg_0[1], creg_0[0])
			with main_circ.if_test((creg_0[0],0)) as else_2:
	...
	with case_4(1):
		main_circ.id(qreg_0[1])
bindings = {param_0: -0.046000, param_1: 0.430000, param_2: -0.240000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "499", "CollectLinearFunctions")

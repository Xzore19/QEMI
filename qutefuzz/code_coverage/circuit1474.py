...
subcirc0.x(qreg_0[0])
subcirc0.u(0,0,0.977000, qreg_2[1])
subcirc0.z(qreg_0[0])
...
subcirc2.z(qreg_0[0])
subcirc2.u(0,0,-0.303000, qreg_0[1])
subcirc2.u(0,0,0.386000, qreg_3[0])
subcirc2.z(qreg_0[2])
subcirc2.cx(qreg_0[0],qreg_3[0])
...
subcirc3.x(qreg_0[2])
subcirc3.u(0,0,-0.764000, qreg_0[1])
...
subcirc4.x(qreg_0[0])
subcirc4.z(qreg_0[0])
subcirc4.u(0,0,0.553000, qreg_0[2])
subcirc4.z(qreg_0[2])
...
with else_4:
	...
	with main_circ.if_test((creg_0[0],0)):
		...
		with main_circ.switch(creg_0[0]) as case_2:
			with case_2(0):
				main_circ.append(subcirc1,[1,0,qreg_0[0],qreg_0[1],qreg_0[3]])
			with case_2(1):
				main_circ.barrier(qreg_0[2])
main_circ.measure(qreg_0[2], creg_0[0])
with main_circ.if_test((creg_0[0],0)):
		...
		with case_3(0):
			...
			with main_circ.if_test((creg_0[0],0)) as else_2:
				...
				with main_circ.if_test((creg_1[0],0)) as else_1:
					main_circ.append(subcirc0,[qreg_0[3],qreg_0[0],1,0,qreg_0[2],qreg_0[1]])
				with else_1:
			...
			with else_2:
				...
				with main_circ.switch(creg_0[0]) as case_1:
					with case_1(0):
						main_circ.append(subcirc3,[0,qreg_0[2],qreg_0[3],qreg_0[1],1,qreg_0[0]])
					with case_1(1):
						main_circ.id(0)
		with case_3(1):
			main_circ.measure(qreg_0[0], creg_0[0])
			with main_circ.switch(creg_0[0]) as case_2:
				with case_2(0):
					...
					with main_circ.if_test((creg_1[0],0)) as else_1:
						...
						main_circ.append(subcirc3,[qreg_0[0],0,1,qreg_0[2],qreg_0[3],qreg_0[1]])
					with else_1:
				...
				with case_2(1):
					...
					with else_1:
						main_circ.append(subcirc0,[0,1,qreg_0[0],qreg_0[1],qreg_0[2],qreg_0[3]])
...
run_on_simulator(main_circ, "1474")

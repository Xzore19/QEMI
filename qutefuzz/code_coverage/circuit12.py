...
with main_circ.switch(creg_1[0]) as case_2:
	with case_2(0):
		...
		with main_circ.if_test((creg_1[0],0)):
			main_circ.append(subcirc0,[0,qreg_0[0],qreg_0[3],qreg_0[2]])
	with case_2(1):
		main_circ.measure(qreg_0[3], creg_1[0])
		with main_circ.if_test((creg_1[0],0)) as else_1:
			main_circ.rz(0.273000, qreg_0[3])
...
with main_circ.if_test((creg_1[0],0)):
	...
	with main_circ.if_test((creg_1[0],0)) as else_1:
		main_circ.y(qreg_0[1])
		main_circ.rz(-0.852000, qreg_0[0])
		main_circ.rz(-0.050000, qreg_0[2])
		main_circ.cx(0,qreg_0[2])
	with else_1:
		main_circ.append(subcirc0,[qreg_0[3],0,qreg_0[0],qreg_0[2]])
main_circ.measure(qreg_0[1], creg_1[0])
with main_circ.if_test((creg_1[0],0)):
	main_circ.measure(qreg_0[2], creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
		main_circ.rz(0.422000, qreg_0[1])
	...
	with case_2(0):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			with case_1(0):
				...
				main_circ.rz(-0.634000, 0)
				main_circ.cx(qreg_0[3],qreg_0[1])
			with case_1(1):
				main_circ.cy(0,qreg_0[3])
				main_circ.cx(qreg_0[3],0)
				main_circ.rz(-0.236000, 0)
				main_circ.rz(-0.690000, qreg_0[3])
	with case_2(1):
		main_circ.measure(0, creg_1[0])
		with main_circ.if_test((creg_1[0],0)):
			main_circ.append(subcirc0,[0,qreg_0[0],qreg_0[3],qreg_0[1]])
...
bindings = {param_2: -0.190000, param_3: -0.946000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "12", "CollectLinearFunctions")

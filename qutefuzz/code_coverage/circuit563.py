...
subcirc1.z(qreg_0[2])
subcirc1.s(qreg_0[1])
subcirc1.u(0.118000,0.104000,0.178000, qreg_0[1])
...
with main_circ.if_test((creg_0[1],0)):
	...
	with main_circ.if_test((creg_0[0],0)):
		main_circ.u(-0.783000,-0.089000,param_0, 1)
	main_circ.measure(0, creg_0[1])
	...
	with else_1:
		main_circ.h(1)
		main_circ.u(-0.506000,0.473000,param_3, 0)
		main_circ.z(3)
...
with main_circ.switch(creg_0[1]) as case_2:
	...
	with case_2(1):
		...
		with main_circ.switch(creg_0[1]) as case_1:
			...
			with case_1(1):
				main_circ.z(2)
				main_circ.u(param_0,0.420000,param_6, 2)
				main_circ.h(0)
				main_circ.z(1)
bindings = {param_0: 0.458000, param_3: 0.761000, param_6: -0.923000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "563")

	...
	with case_2(0):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			with case_1(0):
				...
				main_circ.u(param_0,0,0.880000, qreg_0[1])
			with case_1(1):
...
with main_circ.if_test((creg_0[0],0)):
	...
	with main_circ.switch(creg_1[0]) as case_1:
		...
		with case_1(1):
			main_circ.u(param_1,0,param_2, qreg_2[1])
			main_circ.s(qreg_2[1])
			main_circ.s(qreg_0[0])
			main_circ.z(qreg_0[0])
...
with main_circ.if_test((creg_0[0],0)):
	...
	with main_circ.switch(creg_0[0]) as case_1:
		with case_1(0):
			...
			main_circ.s(1)
		with case_1(1):
			main_circ.u(param_2,param_0,0.845000, qreg_2[1])
			main_circ.z(qreg_2[0])
			main_circ.z(qreg_0[1])
			main_circ.u(0,0,-0.453000, qreg_2[0])
bindings = {param_0: 0.805000, param_1: 0.997000, param_2: -0.527000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1897", "ElidePermutations")

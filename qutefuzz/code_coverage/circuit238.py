...
main_circ.append(subcirc2,[1,qreg_1[0],0,2,3])
main_circ.append(subcirc3,[0,3,qreg_1[0],1])
main_circ.append(subcirc3,[qreg_0[0],1,2,qreg_1[0]])
main_circ.rz(param_0, 3)
main_circ.append(subcirc4,[qreg_1[0],1,2,qreg_0[0],3])
main_circ.append(subcirc1,[1,qreg_1[0],0,3])
main_circ.append(subcirc3,[3,qreg_0[0],qreg_1[0],2])
main_circ.cx(2,1)
main_circ.cx(0,1)
main_circ.append(subcirc4,[2,qreg_1[0],1,3,qreg_0[0]])
main_circ.cx(qreg_0[0],1)
main_circ.append(subcirc0,[1,0,3,qreg_1[0]])
main_circ.h(3)
main_circ.cx(3,2)
main_circ.append(subcirc4,[0,qreg_0[0],1,qreg_1[0],3])
main_circ.x(2)
main_circ.cx(2,3)
main_circ.h(qreg_1[0])
main_circ.x(0)
main_circ.rz(param_1, qreg_0[0])
bindings = {param_0: 0.660000, param_1: 0.969000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "238")

...
subcirc0.u(pi/2,-0.368000,-0.301000, qreg_0[1])
subcirc0.u(pi/2,-0.976000,0.758000, qreg_0[1])
...
subcirc1.u(pi/2,-0.136000,-0.792000, qreg_0[0])
subcirc1.rz(-0.776000, qreg_0[2])
subcirc1.rz(0.545000, qreg_0[1])
subcirc1.rz(-0.442000, qreg_0[0])
subcirc1.z(qreg_3[0])
...
# Adding creg resources 
subcirc2.rz(0.120000, qreg_0[3])
subcirc2.rz(-0.161000, qreg_0[1])
subcirc2.rz(0.215000, qreg_0[1])
subcirc2.z(qreg_0[0])
subcirc2.rz(-0.675000, qreg_0[1])
	...
	with main_circ.switch(creg_0[0]) as case_2:
		with case_2(0):
			...
			with main_circ.if_test((creg_0[0],0)):
				main_circ.u(pi/2,-0.366000,param_0, 3)
...
with else_3:
	...
	with main_circ.if_test((creg_0[1],0)):
		...
		with else_1:
			...
			main_circ.append(subcirc3,[3,2,0,qreg_0[0]])
main_circ.measure(qreg_0[0], creg_0[0])
	...
	with case_3(1):
		...
		with main_circ.if_test((creg_0[1],0)):
			...
			with main_circ.if_test((creg_0[1],0)) as else_1:
				main_circ.rz(-0.660000, qreg_1[0])
				main_circ.z(qreg_1[0])
...
with main_circ.if_test((creg_0[0],0)):
	...
	with else_2:
		...
		main_circ.id(qreg_0[0])
	main_circ.id(2)
bindings = {param_0: -0.212000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1663")

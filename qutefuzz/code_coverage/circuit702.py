...
subcirc0.rx(0.936000, qreg_0[2])
subcirc0.ry(0.526000, qreg_0[2])
subcirc0.y(qreg_0[2])
subcirc0.s(qreg_0[1])
...
# Adding creg resources 
subcirc2.s(qreg_2[0])
subcirc2.ry(0.077000, qreg_0[1])
subcirc2.rx(0.521000, qreg_3[0])
subcirc2.ry(0.559000, qreg_2[0])
subcirc2.ry(-0.183000, qreg_2[0])
		...
		with main_circ.if_test((creg_0[1],0)):
			...
			with main_circ.if_test((creg_0[1],0)) as else_2:
				...
				with main_circ.switch(creg_0[1]) as case_1:
					with case_1(0):
						main_circ.append(subcirc1,[qreg_0[1],qreg_0[0],qreg_0[2],qreg_0[3]])
					with case_1(1):
			...
			with else_2:
				...
				with main_circ.switch(creg_0[1]) as case_1:
					with case_1(0):
						...
						main_circ.rx(-0.805000, qreg_0[3])
	...
	with case_4(1):
		...
		with main_circ.if_test((creg_0[1],0)) as else_3:
			...
			with main_circ.if_test((creg_0[0],0)):
				...
				with main_circ.switch(creg_0[1]) as case_1:
					with case_1(0):
						main_circ.ry(-0.727000, qreg_0[3])
...
main_circ.y(qreg_0[2])
main_circ.rx(-0.637000, qreg_0[2])
main_circ.measure(qreg_0[2], creg_0[1])
with main_circ.if_test((creg_0[1],0)):
	main_circ.measure(qreg_0[3], creg_0[1])
	with main_circ.if_test((creg_0[1],0)) as else_3:
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			main_circ.rx(0.968000, qreg_0[2])
...
bindings = {param_2: 0.595000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "702")

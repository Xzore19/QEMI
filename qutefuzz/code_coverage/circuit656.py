...
subcirc0.u(0.848000,0.521000,-0.277000, qreg_0[2])
...
# Adding creg resources 
subcirc1.x(qreg_0[0])
subcirc1.u(0.300000,0.656000,0.438000, qreg_0[0])
subcirc1.u(-0.112000,-0.620000,-0.702000, qreg_3[0])
subcirc1.u(0.999000,0.666000,-0.813000, qreg_2[0])
...
subcirc2.u(-0.460000,-0.214000,-0.055000, qreg_1[0])
subcirc2.x(qreg_0[0])
...
subcirc3.x(qreg_0[1])
subcirc3.x(qreg_0[2])
subcirc3.u(-0.592000,0.235000,0.626000, qreg_0[0])
...
subcirc4.cy(qreg_3[0],qreg_0[1])
subcirc4.cx(qreg_0[1],qreg_0[0])
subcirc4.cy(qreg_0[2],qreg_0[0])
subcirc4.cx(qreg_0[2],qreg_3[0])
		...
		with main_circ.if_test((creg_0[0],0)) as else_3:
			...
			with main_circ.if_test((creg_1[0],0)) as else_2:
				...
				with main_circ.if_test((creg_0[0],0)):
					main_circ.u(param_4,0.958000,0.492000, 0)
					main_circ.cx(0,2)
					main_circ.cy(0,2)
			with else_2:
				main_circ.measure(1, creg_0[0])
				with main_circ.switch(creg_0[0]) as case_1:
					...
					with case_1(1):
						main_circ.cx(2,1)
						main_circ.u(0.919000,param_4,-0.644000, 2)
...
with else_4:
	...
	with main_circ.switch(creg_1[0]) as case_3:
		...
		with case_3(1):
			main_circ.barrier(1)
	main_circ.id(3)
bindings = {param_4: -0.098000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "656", "CommutativeCancellation")

...
subcirc1.rz(-0.370000, qreg_2[0])
subcirc1.cz(qreg_2[0],qreg_0[1])
subcirc1.rz(-0.658000, qreg_0[1])
...
bindings = {param_2: -0.872000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1077", "HoareOptimizer")

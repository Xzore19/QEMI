		...
		with main_circ.if_test((creg_0[0],0)):
			...
			with main_circ.switch(creg_0[0]) as case_1:
				with case_1(0):
					...
					main_circ.barrier(0)
				with case_1(1):
					main_circ.ry(-0.098000, 0)
					main_circ.z(3)
					main_circ.barrier(0)
bindings = {param_2: -0.192000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1543", "CollectLinearFunctions")

...
subcirc3.s(qreg_3[0])
subcirc3.y(qreg_2[0])
subcirc3.rx(0.061000, qreg_0[0])
subcirc3.cx(qreg_2[0],qreg_3[0])
subcirc3.rx(-0.807000, qreg_2[0])
...
subcirc4.rx(-0.925000, qreg_0[0])
subcirc4.y(qreg_0[3])
subcirc4.cx(qreg_0[1],qreg_0[2])
subcirc4.rx(-0.803000, qreg_0[0])
subcirc4.rx(-0.373000, qreg_0[0])
...
with main_circ.if_test((creg_0[1],0)) as else_4:
	main_circ.append(subcirc4,[2,0,1,qreg_0[0],3])
with else_4:
	...
	with main_circ.if_test((creg_0[1],0)):
		...
		with main_circ.if_test((creg_0[1],0)) as else_2:
			...
			with main_circ.if_test((creg_0[0],0)) as else_1:
				main_circ.barrier(2)
			with else_1:
				main_circ.rx(-0.345000, 2)
				main_circ.append(subcirc4,[0,3,2,qreg_0[0],1])
		with else_2:
			...
			with main_circ.switch(creg_0[1]) as case_1:
				...
				with case_1(1):
					...
					main_circ.cx(2,qreg_0[0])
					main_circ.append(subcirc4,[0,1,qreg_0[0],3,2])
main_circ.cx(0,2)
		...
		with case_3(1):
			...
			with main_circ.if_test((creg_0[1],0)):
				...
				with main_circ.if_test((creg_0[0],0)):
					...
					main_circ.rx(0.139000, qreg_0[0])
					main_circ.s(0)
					main_circ.barrier(2)
				main_circ.barrier(3)
with else_4:
	...
	with else_3:
		...
		main_circ.barrier(2)
	main_circ.barrier(0)
bindings = {param_1: -0.158000, param_3: 0.218000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1006", "CollectCliffords")

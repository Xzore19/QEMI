...
subcirc0.u(0.802000,-0.983000,0.446000, qreg_0[0])
subcirc0.z(qreg_0[2])
...
with main_circ.if_test((creg_1[0],0)) as else_2:
	...
	main_circ.u(param_2,param_1,0.812000, 0)
with else_2:
...
with main_circ.switch(creg_1[0]) as case_2:
	...
	with case_2(1):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			with case_1(0):
				main_circ.cx(qreg_0[1],qreg_0[3])
				main_circ.u(param_2,param_0,-0.366000, 0)
...
with main_circ.if_test((creg_1[0],0)) as else_2:
	...
	main_circ.measure(qreg_0[3], creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
		main_circ.u(param_1,-0.977000,param_0, qreg_0[1])
	main_circ.measure(qreg_0[2], creg_1[0])
	with main_circ.if_test((creg_1[0],0)) as else_1:
		main_circ.u(param_2,-0.488000,param_0, qreg_0[3])
		main_circ.z(qreg_0[0])
		main_circ.cz(qreg_0[1],0)
	with else_1:
		main_circ.cz(qreg_0[1],qreg_0[0])
		main_circ.cx(qreg_0[1],0)
		main_circ.u(0.013000,param_2,param_2, qreg_0[1])
...
bindings = {param_0: 0.864000, param_1: -0.548000, param_2: -0.382000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "608")

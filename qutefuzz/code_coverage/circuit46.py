...
subcirc0.ry(0.777000, qreg_0[0])
subcirc0.z(qreg_2[0])
subcirc0.ry(-0.067000, qreg_0[1])
subcirc0.z(qreg_0[0])
subcirc0.ry(-0.587000, qreg_0[0])
...
# Adding creg resources 
subcirc2.ry(0.460000, qreg_0[2])
subcirc2.z(qreg_3[0])
subcirc2.z(qreg_0[0])
subcirc2.cx(qreg_0[2],qreg_0[0])
subcirc2.ry(0.927000, qreg_0[1])
...
with main_circ.switch(creg_1[0]) as case_4:
	...
	with case_4(1):
		main_circ.id(1)
bindings = {param_0: 0.580000, param_4: 0.045000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "46")

...
# Adding creg resources 
subcirc1.u(0.715000,-0.034000,-0.404000, qreg_0[1])
subcirc1.u(0.441000,-0.054000,-0.278000, qreg_0[1])
subcirc1.rz(0.245000, qreg_0[2])
subcirc1.s(qreg_0[3])
subcirc1.h(qreg_0[1])
...
subcirc2.s(qreg_0[3])
subcirc2.s(qreg_0[3])
subcirc2.rz(0.023000, qreg_0[1])
subcirc2.rz(-0.176000, qreg_0[0])
subcirc2.h(qreg_0[1])
...
with main_circ.if_test((creg_1[0],0)):
	...
	with main_circ.if_test((creg_1[0],0)):
		...
		main_circ.rz(0.879000, qreg_0[0])
...
with main_circ.if_test((creg_0[0],0)):
	main_circ.measure(qreg_0[2], creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
		main_circ.u(-0.828000,param_0,-0.504000, qreg_0[1])
	main_circ.measure(qreg_0[0], creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
...
with main_circ.if_test((creg_1[0],0)) as else_2:
	...
	with main_circ.switch(creg_1[0]) as case_1:
		with case_1(0):
			...
			main_circ.rz(-0.156000, qreg_0[2])
...
with else_2:
	...
	main_circ.append(subcirc2,[qreg_0[2],qreg_0[0],qreg_3[0],qreg_0[1]])
bindings = {param_0: 0.954000, param_2: 0.117000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1106")

...
subcirc0.u(pi/2,0.961000,-0.423000, qreg_0[0])
subcirc0.s(qreg_0[0])
subcirc0.x(qreg_0[2])
...
subcirc1.x(qreg_0[1])
subcirc1.x(qreg_0[0])
subcirc1.u(pi/2,-0.839000,0.338000, qreg_0[2])
subcirc1.u(pi/2,0.935000,-0.459000, qreg_0[2])
...
subcirc3.u(pi/2,0.935000,-0.990000, qreg_0[0])
subcirc3.s(qreg_0[0])
...
subcirc4.u(pi/2,0.035000,-0.976000, qreg_0[0])
...
run_on_simulator(main_circ, "991")

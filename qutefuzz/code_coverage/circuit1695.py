	...
	with main_circ.if_test((creg_1[0],0)):
		...
		with main_circ.switch(creg_1[0]) as case_1:
			...
			with case_1(1):
				...
				main_circ.u(0,0,-0.908000, qreg_0[2])
				main_circ.s(qreg_0[0])
				main_circ.cx(qreg_0[2],qreg_0[0])
with else_3:
	main_circ.measure(qreg_0[1], creg_1[0])
	with main_circ.if_test((creg_1[0],0)) as else_2:
		main_circ.u(0,0,-0.905000, qreg_3[0])
	...
	with else_2:
		...
		with main_circ.if_test((creg_1[0],0)) as else_1:
			...
			main_circ.u(param_0,0,0.629000, qreg_0[1])
			main_circ.y(qreg_3[0])
		with else_1:
	...
	with case_3(0):
		...
		with else_2:
			...
			with main_circ.if_test((creg_0[0],0)) as else_1:
				...
				main_circ.u(0,0,0.773000, qreg_0[0])
				main_circ.y(qreg_0[0])
			with else_1:
				main_circ.y(qreg_3[0])
				main_circ.s(qreg_0[0])
				main_circ.u(param_0,param_0,-0.688000, qreg_3[0])
	with case_3(1):
		main_circ.measure(qreg_0[1], creg_1[0])
		with main_circ.if_test((creg_1[0],0)):
			main_circ.measure(qreg_0[1], creg_1[0])
...
run_on_simulator(main_circ, "1695")

...
subcirc1.ry(0.209000, qreg_3[0])
subcirc1.cz(qreg_3[0],qreg_0[1])
subcirc1.rx(0.313000, qreg_0[2])
...
# Adding creg resources 
subcirc2.ry(0.579000, qreg_1[0])
subcirc2.rx(0.618000, qreg_1[2])
subcirc2.rx(0.642000, qreg_1[0])
...
main_circ.append(subcirc3,[0,qreg_0[0],qreg_3[0],qreg_0[1]])
main_circ.rx(param_1, qreg_0[1])
main_circ.append(subcirc3,[qreg_0[0],qreg_3[0],qreg_2[0],0])
...
main_circ.ry(-0.527000, qreg_0[0])
main_circ.append(subcirc3,[qreg_0[0],qreg_2[0],qreg_3[0],qreg_0[1]])
main_circ.ry(0.846000, qreg_3[0])
...
main_circ.append(subcirc3,[qreg_0[0],0,qreg_0[1],qreg_2[0]])
main_circ.append(subcirc2,[qreg_0[0],0,qreg_0[1],qreg_3[0]])
main_circ.append(subcirc3,[0,qreg_0[0],qreg_0[1],qreg_2[0]])
main_circ.cx(0,qreg_0[0])
main_circ.cx(qreg_2[0],qreg_3[0])
main_circ.append(subcirc0,[qreg_0[1],qreg_0[0],0,qreg_2[0]])
bindings = {param_0: 0.967000, param_1: 0.321000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "518")

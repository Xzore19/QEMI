...
subcirc0.ry(0.249000, qreg_3[0])
subcirc0.ry(-0.695000, qreg_3[0])
subcirc0.cy(qreg_0[1],qreg_3[0])
subcirc0.cy(qreg_0[1],qreg_0[0])
subcirc0.ry(-0.627000, qreg_0[2])
...
# Adding creg resources 
subcirc2.ry(-0.326000, qreg_2[0])
subcirc2.cy(qreg_2[0],qreg_1[0])
...
main_circ.ry(0.702000, qreg_1[2])
main_circ.append(subcirc0,[qreg_0[0],qreg_1[0],qreg_1[2],0])
...
bindings = {param_0: -0.772000, param_3: 0.592000, param_4: -0.708000, }

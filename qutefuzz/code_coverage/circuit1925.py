...
subcirc0.h(qreg_1[1])
subcirc0.u(0,0,-0.094000, qreg_1[1])
...
# Adding creg resources 
subcirc1.u(0,0,-0.485000, qreg_0[2])
subcirc1.s(qreg_0[0])
subcirc1.u(0,0,0.436000, qreg_0[2])
subcirc1.h(qreg_0[2])
		...
		with main_circ.switch(creg_0[1]) as case_2:
			with case_2(0):
				...
				with main_circ.if_test((creg_0[1],0)) as else_1:
					main_circ.u(param_2,param_2,param_0, qreg_3[0])
				with else_1:
					main_circ.u(param_4,0,0.651000, qreg_1[0])
					main_circ.u(0,0,-0.175000, qreg_3[0])
			...
			with case_2(1):
				...
				with main_circ.switch(creg_0[0]) as case_1:
					...
					with case_1(1):
						main_circ.u(param_2,0,-0.951000, qreg_0[0])
						main_circ.append(subcirc1,[qreg_1[0],qreg_3[0],qreg_0[0],qreg_2[0]])
	with else_3:
		main_circ.measure(qreg_1[0], creg_0[1])
		with main_circ.switch(creg_0[1]) as case_2:
			with case_2(0):
				...
				with else_1:
					main_circ.u(param_3,param_0,-0.189000, qreg_3[0])
			with case_2(1):
				main_circ.measure(qreg_2[0], creg_0[0])
				with main_circ.if_test((creg_0[0],0)) as else_1:
					main_circ.barrier(qreg_1[0])
				with else_1:
					main_circ.u(0,param_4,param_1, qreg_1[0])
...
with else_4:
	...
	with main_circ.if_test((creg_0[0],0)):
		...
		main_circ.barrier(qreg_3[0])
	main_circ.id(qreg_2[0])
bindings = {param_0: 0.049000, param_1: -0.767000, param_2: 0.132000, param_3: -0.161000, param_4: -0.327000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1925")

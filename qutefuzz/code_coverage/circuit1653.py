...
# Adding creg resources 
subcirc1.h(qreg_1[1])
subcirc1.u(pi/2,-0.603000,0.075000, qreg_1[0])
subcirc1.z(qreg_1[1])
subcirc1.u(pi/2,0.220000,0.171000, qreg_1[0])
...
# Adding creg resources 
subcirc2.u(pi/2,0.322000,-0.036000, qreg_0[2])
subcirc2.u(pi/2,0.223000,-0.866000, qreg_0[2])
...
# Adding creg resources 
subcirc3.h(qreg_0[0])
subcirc3.u(pi/2,-0.343000,-0.807000, qreg_0[0])
subcirc3.u(pi/2,-0.562000,0.522000, qreg_0[2])
	...
	with case_3(0):
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			with main_circ.switch(creg_1[0]) as case_1:
				...
				with case_1(1):
					main_circ.cx(0,2)
					main_circ.u(param_2,0.118000,-0.580000, 3)
...
with main_circ.switch(creg_1[0]) as case_3:
	...
	with case_3(1):
		main_circ.id(0)
bindings = {param_2: -0.673000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_on_simulator(main_circ, "1653")

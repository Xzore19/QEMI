...
subcirc0.ry(0.122000, qreg_0[0])
subcirc0.cx(qreg_0[2],qreg_0[1])
subcirc0.ry(0.840000, qreg_0[3])
...
main_circ.cy(3,2)
bindings = {param_0: -0.918000, param_1: -0.302000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "1548")

...
# Adding creg resources 
subcirc2.rz(-0.012000, qreg_0[3])
subcirc2.rz(0.404000, qreg_0[0])
subcirc2.h(qreg_0[0])
subcirc2.x(qreg_0[0])
...
with main_circ.switch(creg_0[0]) as case_2:
	...
	with case_2(1):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			...
			with case_1(1):
				main_circ.h(qreg_0[1])
				main_circ.rz(0.527000, qreg_0[0])
				main_circ.h(qreg_0[1])
...
with main_circ.switch(creg_0[1]) as case_2:
	with case_2(0):
		...
		with else_1:
			main_circ.rz(-0.634000, qreg_0[0])
...
run_pass_on_simulator(main_circ, "1846", "ResetAfterMeasureSimplification")

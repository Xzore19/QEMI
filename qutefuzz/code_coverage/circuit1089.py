...
# Adding creg resources 
subcirc1.rz(0.098000, qreg_0[0])
subcirc1.cy(qreg_0[1],qreg_0[3])
subcirc1.y(qreg_0[0])
subcirc1.rz(0.671000, qreg_0[3])
subcirc1.y(qreg_0[0])
subcirc1.h(qreg_0[0])
...
main_circ.rz(-0.206000, qreg_0[0])
...
main_circ.rz(-0.654000, qreg_0[0])
...
main_circ.append(subcirc1,[qreg_0[1],qreg_3[0],qreg_0[2],qreg_0[0]])
main_circ.cy(qreg_0[1],qreg_3[0])
bindings = {param_0: -0.020000, param_1: 0.689000, }

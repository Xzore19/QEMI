...
subcirc0.z(qreg_2[1])
subcirc0.u(0,0,-0.565000, qreg_2[0])
subcirc0.cx(qreg_2[0],qreg_0[0])
subcirc0.z(qreg_0[0])
subcirc0.cx(qreg_2[0],qreg_2[1])
subcirc0.u(0,0,0.432000, qreg_0[0])
...
main_circ.u(0,0,0.781000, qreg_0[0])
...
main_circ.z(1)
main_circ.u(param_2,param_0,-0.209000, 3)
main_circ.cx(qreg_0[0],3)
main_circ.cx(qreg_0[0],1)
main_circ.cx(3,0)
main_circ.u(0,param_0,0.732000, 2)
...
main_circ.z(2)
bindings = {param_0: -0.260000, param_1: 0.865000, param_2: 0.124000, }

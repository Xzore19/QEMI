...
subcirc0.x(qreg_0[2])
subcirc0.rz(-0.227000, qreg_0[3])
subcirc0.cx(qreg_0[0],qreg_0[1])
subcirc0.y(qreg_0[3])
subcirc0.x(qreg_0[0])
subcirc0.rz(-0.744000, qreg_0[2])
...
with main_circ.if_test((creg_0[1],0)):
	...
	with main_circ.if_test((creg_0[0],0)):
		...
		with else_1:
			main_circ.rz(0.377000, qreg_0[0])
		...
		with else_2:
			...
			with main_circ.switch(creg_0[1]) as case_1:
				...
				with case_1(1):
					...
					main_circ.append(subcirc3,[2,0,3,qreg_0[0],qreg_1[0]])
main_circ.measure(2, creg_0[1])
with main_circ.if_test((creg_0[1],0)) as else_3:
	...
	with main_circ.if_test((creg_0[1],0)):
		...
		with main_circ.if_test((creg_0[1],0)) as else_1:
			main_circ.append(subcirc3,[1,qreg_1[0],qreg_0[0],3,2])
		with else_1:
	...
	with main_circ.switch(creg_0[0]) as case_2:
		...
		with case_2(1):
			...
			with main_circ.switch(creg_0[1]) as case_1:
				...
				with case_1(1):
					main_circ.rz(-0.190000, 1)
					main_circ.rz(0.183000, 1)
					main_circ.id(1)
			main_circ.measure(3, creg_0[0])
			...
			main_circ.id(0)
bindings = {param_2: 0.210000, param_3: -0.148000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "1767", "NormalizeRXAngle")

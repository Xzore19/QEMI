...
# Adding creg resources 
subcirc1.rx(0.959000, qreg_2[0])
subcirc1.z(qreg_2[0])
subcirc1.rx(0.925000, qreg_0[0])
...
with main_circ.if_test((creg_0[1],0)):
	...
	with main_circ.switch(creg_0[0]) as case_1:
		with case_1(0):
			...
			main_circ.rx(0.263000, qreg_0[2])
...
with main_circ.if_test((creg_0[1],0)) as else_2:
	main_circ.measure(qreg_0[0], creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
		main_circ.append(subcirc0,[0,qreg_0[3],qreg_0[1],qreg_0[0]])
with else_2:
	main_circ.measure(qreg_0[1], creg_0[0])
	with main_circ.if_test((creg_0[0],0)):
		main_circ.append(subcirc1,[qreg_0[3],qreg_0[0],0,qreg_0[1]])
main_circ.measure(qreg_0[0], creg_0[0])
...
with else_2:
	...
	with else_1:
		main_circ.z(0)
		main_circ.id(0)
bindings = {param_0: -0.541000, param_2: -0.112000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "953", "Collect1qRuns")

...
with main_circ.switch(creg_0[0]) as case_4:
	with case_4(0):
		...
		with main_circ.switch(creg_1[0]) as case_3:
			...
			with case_3(1):
				main_circ.append(subcirc2,[1,0,3,qreg_0[0],2])
	with case_4(1):
		...
		with case_3(0):
			...
			with main_circ.switch(creg_0[0]) as case_2:
				with case_2(0):
					main_circ.measure(2, creg_1[0])
					with main_circ.if_test((creg_1[0],0)):
						main_circ.append(subcirc2,[2,0,1,3,qreg_0[0]])
				with case_2(1):
					main_circ.append(subcirc4,[3,1,2,0,qreg_0[0]])
		with case_3(1):
			main_circ.s(2)
			main_circ.measure(2, creg_1[0])
			with main_circ.if_test((creg_1[0],0)):
				...
				with main_circ.if_test((creg_0[0],0)) as else_1:
					main_circ.append(subcirc3,[1,qreg_0[0],2,3])
				with else_1:
					main_circ.h(0)
...
with else_4:
	...
	with main_circ.if_test((creg_0[0],0)) as else_3:
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			...
			with main_circ.if_test((creg_0[0],0)) as else_1:
				main_circ.y(2)
				main_circ.append(subcirc2,[0,3,1,2,qreg_0[0]])
			with else_1:
				main_circ.barrier(2)
		with else_2:
			main_circ.measure(3, creg_1[0])
...
run_pass_on_simulator(main_circ, "1895", "ResetAfterMeasureSimplification")

...
with main_circ.switch(creg_0[0]) as case_2:
	...
	with case_2(1):
		...
		with main_circ.if_test((creg_0[0],0)):
			main_circ.append(subcirc3,[qreg_0[0],qreg_0[1],qreg_0[3],0,qreg_0[2]])
...
with main_circ.switch(creg_1[0]) as case_2:
	with case_2(0):
		...
		with main_circ.if_test((creg_0[0],0)):
			...
			main_circ.append(subcirc4,[qreg_0[2],qreg_0[1],qreg_0[3],qreg_0[0]])
	with case_2(1):
		main_circ.measure(qreg_0[3], creg_1[0])
		with main_circ.if_test((creg_1[0],0)):
			main_circ.append(subcirc4,[0,qreg_0[2],qreg_0[0],qreg_0[1]])
...
with main_circ.if_test((creg_1[0],0)):
	...
	with main_circ.switch(creg_1[0]) as case_1:
		with case_1(0):
			main_circ.cz(qreg_0[2],qreg_0[0])
			main_circ.append(subcirc3,[qreg_0[2],0,qreg_0[0],qreg_0[3],qreg_0[1]])
		with case_1(1):
...
with main_circ.switch(creg_0[0]) as case_2:
	...
	with case_2(1):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			with case_1(0):
				main_circ.append(subcirc3,[qreg_0[0],qreg_0[3],qreg_0[1],qreg_0[2],0])
			with case_1(1):
...
run_pass_on_simulator(main_circ, "339", "Optimize1qGates")

...
subcirc0.rz(0.811000, qreg_1[0])
subcirc0.cx(qreg_0[0],qreg_3[0])
subcirc0.rx(0.196000, qreg_1[0])
subcirc0.cx(qreg_1[0],qreg_0[0])
subcirc0.z(qreg_3[0])
subcirc0.rz(0.438000, qreg_0[0])
	...
	with main_circ.if_test((creg_0[1],0)):
		...
		with main_circ.if_test((creg_0[0],0)) as else_2:
			...
			with main_circ.switch(creg_0[0]) as case_1:
				...
				with case_1(1):
					main_circ.rz(-0.904000, 3)
					main_circ.rz(-0.829000, 2)
					main_circ.z(1)
					main_circ.cx(1,3)
		with else_2:
			main_circ.measure(0, creg_0[1])
			...
			with main_circ.switch(creg_0[0]) as case_1:
				...
				with case_1(1):
					main_circ.id(2)
			main_circ.id(1)
bindings = {param_0: -0.510000, param_1: -0.408000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_pass_on_simulator(main_circ, "898", "ElidePermutations")

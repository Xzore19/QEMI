...
subcirc0.u(0,0,-0.987000, qreg_0[1])
subcirc0.rz(-0.856000, qreg_0[1])
subcirc0.cx(qreg_0[1],qreg_0[2])
subcirc0.rz(0.445000, qreg_0[1])
...
main_circ.u(param_0,param_0,0.033000, qreg_3[0])
main_circ.u(0,0,param_1, qreg_3[0])
main_circ.append(subcirc1,[qreg_0[0],qreg_1[0],qreg_3[0],1])
main_circ.cy(qreg_3[0],1)
main_circ.append(subcirc1,[qreg_3[0],qreg_0[0],qreg_1[0],0])
main_circ.rz(0.814000, qreg_1[0])
main_circ.append(subcirc2,[qreg_1[1],1,qreg_3[0],qreg_0[0],0,qreg_1[0]])
main_circ.u(0,0,0.545000, qreg_3[0])
main_circ.append(subcirc1,[0,qreg_0[0],qreg_3[0],qreg_1[0]])
main_circ.cy(qreg_3[0],qreg_0[0])
main_circ.u(0,0,param_2, qreg_0[0])
main_circ.append(subcirc2,[0,qreg_0[0],qreg_3[0],qreg_1[1],1,qreg_1[0]])
main_circ.rz(-0.834000, qreg_1[0])
main_circ.cy(qreg_1[1],0)
main_circ.u(0,0,param_2, qreg_3[0])
main_circ.u(param_1,0,0.150000, 1)
main_circ.u(0,param_2,-0.344000, qreg_1[0])
main_circ.cy(qreg_1[0],qreg_1[1])
main_circ.rz(param_0, 0)
bindings = {param_0: 0.195000, param_1: 0.572000, param_2: 0.444000, }

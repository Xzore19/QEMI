...
subcirc0.z(qreg_2[0])
subcirc0.y(qreg_0[1])
subcirc0.u(pi/2,0.270000,-0.905000, qreg_2[0])
...
# Adding creg resources 
subcirc1.u(pi/2,0.792000,-0.886000, qreg_0[3])
subcirc1.u(pi/2,0.933000,0.364000, qreg_0[2])
subcirc1.x(qreg_0[1])
subcirc1.z(qreg_0[2])
subcirc1.u(pi/2,-0.229000,0.627000, qreg_0[3])
subcirc1.x(qreg_0[1])
...
with main_circ.switch(creg_0[1]) as case_1:
	with case_1(0):
		main_circ.y(0)
		main_circ.u(pi/2,0.441000,param_0, 0)
		main_circ.z(0)
...
run_on_simulator(main_circ, "1990")

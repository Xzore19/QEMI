...
main_circ.append(subcirc1,[qreg_2[0],0,qreg_0[0],qreg_2[1],qreg_0[1]])
main_circ.append(subcirc1,[0,qreg_0[1],qreg_0[0],qreg_2[1],qreg_2[0]])
main_circ.cy(qreg_2[1],0)
main_circ.h(qreg_2[0])
main_circ.cy(qreg_2[1],0)
main_circ.cy(qreg_2[1],qreg_2[0])
main_circ.append(subcirc1,[qreg_2[0],qreg_0[1],qreg_2[1],qreg_0[0],0])
main_circ.append(subcirc1,[qreg_2[0],qreg_0[0],0,qreg_2[1],qreg_0[1]])
main_circ.cy(qreg_2[0],qreg_2[1])
main_circ.h(qreg_0[1])
main_circ.s(qreg_2[0])
main_circ.h(0)
main_circ.s(qreg_0[1])
main_circ.append(subcirc1,[qreg_2[1],0,qreg_2[0],qreg_0[0],qreg_0[1]])

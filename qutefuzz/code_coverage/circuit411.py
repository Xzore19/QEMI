...
subcirc1.y(qreg_2[0])
subcirc1.y(qreg_0[1])
subcirc1.rz(0.509000, qreg_2[1])
subcirc1.rz(0.464000, qreg_2[1])
subcirc1.x(qreg_2[0])
subcirc1.y(qreg_2[1])
...
main_circ.append(subcirc0,[qreg_0[3],1,0,qreg_0[0]])
...
main_circ.y(1)
main_circ.append(subcirc2,[1,qreg_0[3],qreg_0[2],0])
main_circ.x(qreg_0[3])
main_circ.x(qreg_0[2])
main_circ.append(subcirc2,[qreg_0[3],qreg_0[0],qreg_0[1],qreg_0[2]])
main_circ.cz(0,1)
...
main_circ.append(subcirc2,[qreg_0[0],qreg_0[3],1,qreg_0[1]])
main_circ.x(1)
main_circ.y(qreg_0[1])
main_circ.cz(0,qreg_0[3])
main_circ.cz(1,qreg_0[3])
bindings = {param_0: 0.004000, param_1: 0.771000, }
main_circ = main_circ.assign_parameters(bindings)

print(Path(__file__).name, " results:")
main_circ.measure_active()
run_routing_simulation(main_circ, "411")

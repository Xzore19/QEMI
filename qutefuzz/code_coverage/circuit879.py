...
with main_circ.if_test((creg_0[1],0)):
	...
	with else_1:
		main_circ.append(subcirc1,[qreg_0[0],0,2,qreg_1[0]])
...
with main_circ.switch(creg_0[1]) as case_2:
	...
	with case_2(1):
		...
		with main_circ.if_test((creg_0[1],0)):
			main_circ.cx(1,0)
			main_circ.cz(qreg_1[0],qreg_0[0])
			main_circ.append(subcirc1,[2,3,qreg_1[0],1])
main_circ.cx(2,1)
main_circ.measure(qreg_1[0], creg_0[0])
with main_circ.switch(creg_0[0]) as case_2:
	with case_2(0):
	...
	with case_2(1):
		...
		with main_circ.switch(creg_0[0]) as case_1:
			with case_1(0):
				main_circ.cx(1,2)
				main_circ.append(subcirc3,[3,qreg_1[0],2,qreg_0[0]])
			with case_1(1):
...
run_pass_on_simulator(main_circ, "879", "CommutativeCancellation")

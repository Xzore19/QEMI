...
cirq.contrib.acquaintance.AcquaintanceOpportunityGate(num_qubits=3).on(q[3],q[1],q[2]) 
cirq.contrib.acquaintance.CircularShiftGate(shift=1, num_qubits=4).on(q[3],q[2],q[4],q[1]) 
cirq.contrib.acquaintance.LinearPermutationGate(num_qubits=2, permutation={0: 1, 1: 0}).on(q[1],q[0]) 
...
cirq.contrib.acquaintance.AcquaintanceOperation([q[1],q[4],q[2]], [1, 4, 2]) 
cirq.contrib.acquaintance.AcquaintanceOpportunityGate(num_qubits=4).on(q[4],q[2],q[1],q[0]) 
sub_circuit = cirq.Circuit() 
sub_circuit.append(cirq.H(q[1]))
sub_circuit.append(cirq.T(q[1]))
sub_circuit.append(cirq.rx(0.02454369260617026).on(q[2]).controlled_by(q[1]))
sub_circuit.append(cirq.CSwapGate().on(q[2], q[4], q[0]).controlled_by(q[3]))
sub_circuit.append(cirq.Z(q[0]))
sub_circuit.append(cirq.YPowGate(exponent=0.39269908169872414).on(q[0]))
sub_circuit.append(cirq.SQRT_ISWAP(q[3], q[1]))
sub_circuit.append(cirq.XPowGate(exponent=0.01227184630308513).on(q[0]).controlled_by(q[1]))
sub_circuit.append(cirq.rx(0.19634954084936207).on(q[0]).controlled_by(q[3]))
...
cirq.contrib.acquaintance.AcquaintanceOperation([q[0],q[3],q[1],q[4]], [0, 3, 1, 4]) 
...
cirq.contrib.acquaintance.CircularShiftGate(shift=1, num_qubits=3).on(q[2],q[4],q[0]) 

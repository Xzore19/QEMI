...
with qc.switch(cr_e0320b) as case: 
	...
	with case(case.DEFAULT): 
		...
		qc.append(RXGate(1.069), [qreg[4]])
		qc.append(TwoLocal(4, reps=1, parameter_prefix='theta_fb0297'), [qreg[2], qreg[1], qreg[3], qreg[0]])
		qc.iswap(4, 1)
		qc.append(EfficientSU2(2, reps=1, parameter_prefix='theta_639900'), [qreg[1], qreg[4]])
qc.t(1)

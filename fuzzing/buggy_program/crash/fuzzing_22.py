...
with qc.for_loop(range(3)) as i_305094:
	...
	qr_305094 = QuantumRegister(2)
	cr_305094 = ClassicalRegister(2)
	qc.add_register(qr_305094)
	qc.add_register(cr_305094)
	qc.x(qr_305094[0])
	qc.x(qr_305094[1])
	qc.measure(qr_305094[0], cr_305094[0]) 
	qc.measure(qr_305094[1], cr_305094[1]) 
	with qc.while_loop((cr_305094, 0b10)): 
		qc.crz(0.39269908169872414, 3, 0)
		qc.append(U3Gate(3.213, 2.446, 0.687), [qreg[1]])
		qc.x(3)
		qc.swap(3, 1)
		qc.ch(3, 2)
		qc.measure(qr_305094[0], cr_305094[0]) 

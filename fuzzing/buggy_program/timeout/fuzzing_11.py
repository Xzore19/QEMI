...
with qc.while_loop((cr_9b6561, 0b11)): 
	...
	with qc.for_loop(range(a)) as i:
		qc.cry(0.7853981633974483, 2, 4)
		qc.append(RXGate(3.917), [qreg[0]])
		qc.append(CUGate(4.249, 0.989, 4.828, 2.118), [qreg[3], qreg[0]])
		aux_aa05d4 = AncillaRegister(5, 'aux_aa05d4')
		qc.add_register(aux_aa05d4)
		qc.append(DraperQFTAdder(5), [qreg[1], qreg[0], aux_aa05d4[2], aux_aa05d4[1], qreg[4], aux_aa05d4[0], qreg[3], aux_aa05d4[3], aux_aa05d4[4], qreg[2]])

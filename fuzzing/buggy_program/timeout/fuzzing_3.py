...
with qc.for_loop(range(3)) as i:
	...
	qr_77fe7e = QuantumRegister(2)
	cr_77fe7e = ClassicalRegister(2)
	qc.add_register(qr_77fe7e)
	qc.add_register(cr_77fe7e)
	qc.x(qr_77fe7e[0])
	qc.x(qr_77fe7e[1])
	qc.measure(qr_77fe7e[0], cr_77fe7e[0]) 
	qc.measure(qr_77fe7e[1], cr_77fe7e[1]) 
	with qc.while_loop((cr_77fe7e, 0b10)): 
		qc.cry(0.7853981633974483, 3, 2)
		qc.append(CXGate(), [qreg[0], qreg[3]])
		qc.append(SwapGate(), [qreg[3], qreg[2]])
		qc.append(U3Gate(2.94, 4.529, 4.499), [qreg[3]])
		qc.ch(4, 2)
		qc.measure(qr_77fe7e[0], cr_77fe7e[0]) 
		qc.measure(qr_77fe7e[1], cr_77fe7e[1]) 

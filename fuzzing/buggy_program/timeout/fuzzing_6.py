...
with qc.while_loop((cr_e335c0, 0b11)): 
	...
	qc.measure(qr_e335c0[0], cr_e335c0[0]) 
	qc.measure(qr_e335c0[1], cr_e335c0[1]) 
	with qc.if_test((cr_e335c0, 0b11)) as else_1: 
		qc.append(QFT(5), [qreg[1], qreg[4], qreg[0], qreg[3], qreg[2]])
		qc.append(EfficientSU2(3, reps=1, parameter_prefix='theta_68ec78'), [qreg[0], qreg[3], qreg[2]])
		qc.append(U3Gate(1.815, 0.101, 1.352), [qreg[0]])
		qc.append(ZZFeatureMap(5, reps=1, parameter_prefix='x_a789ef'), [qreg[1], qreg[0], qreg[2], qreg[4], qreg[3]])
		qc.append(AND(2), [qreg[4], qreg[0], qreg[2]])
	with else_1: 
		qc.append(Permutation(4, pattern=[3, 1, 2, 0]), [qreg[1], qreg[3], qreg[4], qreg[2]])
		aux_a00c7e = AncillaRegister(5, 'aux_a00c7e')
		qc.add_register(aux_a00c7e)
		qc.append(DraperQFTAdder(5), [aux_a00c7e[4], aux_a00c7e[0], qreg[1], aux_a00c7e[1], aux_a00c7e[3], qreg[0], qreg[3], aux_a00c7e[2], qreg[2], qreg[4]])
		qc.append(XOR(3, seed=42), [qreg[2], qreg[0], qreg[1]])
		qc.y(0)
		qc.append(RXGate(2.627), [qreg[3]])

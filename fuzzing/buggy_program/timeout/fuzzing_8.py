...
with qc.while_loop((cr_25eec7, 0b11)): 
	...
	qc.measure(qr_25eec7[0], cr_25eec7[0]) 
	qc.measure(qr_25eec7[1], cr_25eec7[1]) 
	with qc.while_loop((cr_25eec7, 0b10)): 
		qc.append(RealAmplitudes(4, reps=1, parameter_prefix='theta_7966da'), [qreg[4], qreg[1], qreg[3], qreg[2]])
		qc.append(MCPhaseGate(1.0, num_ctrl_qubits=4), [qreg[3], qreg[2], qreg[4], qreg[0], qreg[1]])
		qc.t(1)
		qc.append(HGate(), [qreg[1]])
		qc.append(PauliFeatureMap(2, reps=1, parameter_prefix='x_4e3204'), [qreg[0], qreg[1]])
		qc.measure(qr_25eec7[0], cr_25eec7[0]) 
		qc.measure(qr_25eec7[1], cr_25eec7[1]) 

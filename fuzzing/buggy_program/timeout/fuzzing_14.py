...
with qc.for_loop(range(3)) as i:
	...
	qr_dbe0f8 = QuantumRegister(2)
	cr_dbe0f8 = ClassicalRegister(2)
	qc.add_register(qr_dbe0f8)
	qc.add_register(cr_dbe0f8)
	qc.x(qr_dbe0f8[0])
	qc.x(qr_dbe0f8[1])
	qc.measure(qr_dbe0f8[0], cr_dbe0f8[0]) 
	qc.measure(qr_dbe0f8[1], cr_dbe0f8[1]) 
	with qc.if_test((cr_dbe0f8, 0b11)) as else_1: 
		qc.append(U3Gate(5.48, 2.495, 6.261), [qreg[4]])
		qc.append(CUGate(4.494, 4.027, 5.64, 5.593), [qreg[1], qreg[0]])
		qc.append(Permutation(4, pattern=[1, 2, 0, 3]), [qreg[0], qreg[1], qreg[3], qreg[2]])
		qc.append(XGate(), [qreg[0]])
		qc.append(TwoLocal(2, reps=1, parameter_prefix='theta_323bc8'), [qreg[3], qreg[2]])
	with else_1: 
		qc.cswap(3, 2, 1)
